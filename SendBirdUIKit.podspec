Pod::Spec.new do |s|
	...
	s.platform = :ios, "13.0"
	s.source = { :http => "https://github.com/sendbird/sendbird-uikit-ios/releases/download/#{s.version}/SendBirdUIKit.zip", :sha1 => "4a0c676858efdc792c3e367a45284764c3996325" }
	...
	s.dependency "SendbirdUIMessageTemplate", ">= 3.32.0"
