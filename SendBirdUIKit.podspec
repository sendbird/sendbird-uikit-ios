Pod::Spec.new do |s|
	...
	s.platform = :ios, "12.0"
	s.source = { :http => "https://github.com/sendbird/sendbird-uikit-ios/releases/download/#{s.version}/SendBirdUIKit.zip", :sha1 => "2b2717a2fe4b87226c154cadd64edf44d8c83833" }
