Pod::Spec.new do |s|
	...
	s.platform = :ios, "13.0"
	s.source = { :http => "https://github.com/sendbird/sendbird-uikit-ios/releases/download/#{s.version}/SendBirdUIKit.zip", :sha1 => "65a736cc63bf0e2a7ddb8d13ff9083bb5bf49407" }
	...
	s.dependency "SendbirdUIMessageTemplate", ">= 3.36.2"
