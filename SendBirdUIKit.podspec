Pod::Spec.new do |s|
	...
	s.platform = :ios, "12.0"
	s.source = { :http => "https://github.com/sendbird/sendbird-uikit-ios/releases/download/#{s.version}/SendBirdUIKit.zip", :sha1 => "5f04d214a72f2f286c56c5f5d807d1deb0bc363b" }
