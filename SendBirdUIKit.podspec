Pod::Spec.new do |s|
	...
	s.platform = :ios, "13.0"
	s.source = { :http => "https://github.com/sendbird/sendbird-uikit-ios/releases/download/#{s.version}/SendBirdUIKit.zip", :sha1 => "3a94b2ed2e6cd789f3da01eb6e657cbfaa959cf5" }
	...
	s.dependency "SendbirdUIMessageTemplate", ">= 3.35.5"
