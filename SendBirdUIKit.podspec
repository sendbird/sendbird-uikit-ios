Pod::Spec.new do |s|
	...
	s.platform = :ios, "13.0"
	s.source = { :http => "https://github.com/sendbird/sendbird-uikit-ios/releases/download/#{s.version}/SendBirdUIKit.zip", :sha1 => "312389cab15bd4f39d79671daf24c38ed6e107fe" }
	...
	s.dependency "SendbirdUIMessageTemplate", ">= 3.35.4"
