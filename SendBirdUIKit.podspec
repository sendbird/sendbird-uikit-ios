Pod::Spec.new do |s|
	...
	s.platform = :ios, "12.0"
	s.source = { :http => "https://github.com/sendbird/sendbird-uikit-ios/releases/download/#{s.version}/SendBirdUIKit.zip", :sha1 => "e96a4cbdea84b52d9ac76b84a563bccd2bf5d65c" }
