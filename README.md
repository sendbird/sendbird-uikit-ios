...
- iOS 11+
- Swift 5.0+
- Sendbird Chat SDK for iOS 4.6.6+
...
> Note: Sendbird UIKit for iOS is Sendbird Chat SDK-dependent. The minimum requirement of the Chat SDK for iOS is 4.6.6 or higher.
