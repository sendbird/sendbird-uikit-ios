...
SWIFT_CLASS("_TtC13SendBirdUIKit18SBUMessageBaseCell")
@interface SBUMessageBaseCell : UITableViewCell
...
@interface SBUAdminMessageCell : SBUMessageBaseCell
...
- (void)onClickSetting;
- (void)scrollToTop;
- (void)registerWithAdminMessageCell:(SBUMessageBaseCell * _Nonnull)adminMessageCell nib:(UINib * _Nullable)nib;
- (void)registerWithUserMessageCell:(SBUMessageBaseCell * _Nonnull)userMessageCell nib:(UINib * _Nullable)nib;
- (void)registerWithFileMessageCell:(SBUMessageBaseCell * _Nonnull)fileMessageCell nib:(UINib * _Nullable)nib;
- (void)registerWithCustomMessageCell:(SBUMessageBaseCell * _Nullable)customMessageCell nib:(UINib * _Nullable)nib;
...
@interface SBUFileMessageCell : SBUMessageBaseCell
...
@interface SBUUserMessageCell : SBUMessageBaseCell
