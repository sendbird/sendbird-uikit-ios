Pod::Spec.new do |s|
	...
	s.platform = :ios, "13.0"
	s.source = { :http => "https://github.com/sendbird/sendbird-uikit-ios/releases/download/#{s.version}/SendbirdUIMessageTemplate.zip", :sha1 => "4c38b450a2979986d8ac2d0d73f4aa93413e8c2b" }
