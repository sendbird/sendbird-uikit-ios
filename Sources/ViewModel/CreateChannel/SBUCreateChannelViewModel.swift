...
public protocol SBUCreateChannelViewModelDelegate: SBUCommonViewModelDelegate {
    ...
    /// Called when it has created channel with `SBDMessageListParams` object.
    func createChannelViewModel(
        _ viewModel: SBUCreateChannelViewModel,
        didCreateChannel channel: SBDBaseChannel?,
        withMessageListParams messageListParams: SBDMessageListParams?
    )
...
open class SBUCreateChannelViewModel {
    ...
    public private(set) var userListQuery: SBDApplicationUserListQuery? = nil
    ...
    public func loadNextUserList(reset: Bool, users: [SBUUser]? = nil) {
        ...
        if let users = users {
            ...
            if self.userListQuery == nil {
                ...
                self.userListQuery?.limit = SBUCreateChannelViewModel.limit
            }
