...
public class SBUMain: NSObject {
    ...
    @available(*, unavailable, message: "Using the `initialize(applicationId:migrationStartHandler:completionHandler:)` function, and in the CompletionHandler, please proceed with the following procedure.", renamed: "initialize(applicationId:migrationStartHandler:completionHandler:)") // [NEXT_VERSION]
    ...
    /// - Since: [NEXT_VERSION]
    public static let shortVersion: String = "[NEXT_VERSION]"
    ...
    @available(*, unavailable, renamed: "shortVersion") // [NEXT_VERSION]
