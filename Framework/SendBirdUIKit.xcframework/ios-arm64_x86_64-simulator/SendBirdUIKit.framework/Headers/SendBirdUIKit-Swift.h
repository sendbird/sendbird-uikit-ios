...
- (void)setupStyles;
/// Update top spacing of the message cell with <code>stackViewTopConstraint</code>. As a default, the spacing is <code>16</code>, but it’s <code>4</code> when the message is located among grouped messages.
/// important:
/// Please update <code>stackViewTopConstraint</code> to <code>stackView.topAnchor.constraint</code> before activate.
/// \code
...
/// Dismiss current view controller or pops to <code>SBUBaseChannelListViewController</code> or the root view controller of the current <code>UINavigationController</code>.
/// since:
/// 2.2.13
- (void)popChannel;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
...
@interface SBUBaseChannelSettingViewController (SWIFT_EXTENSION(SendBirdUIKit)) <SBUSelectablePhotoViewDelegate>
- (void)didTapSendImageData:(NSData * _Nonnull)data;
@end
...
/// If <code>baseChannel</code> is type of <code>SBDGroupChannel</code>, it deletes the message by using local caching.
/// If <code>baseChannel</code> is not type of <code>SBDGroupChannel</code> that not using local caching, it calls <code>deleteResendableMessages(requestIds:needReload:)</code>.
/// since:
/// 2.2.0
/// \param message The resendable<code>SBDBaseMessage</code> object such as failed message.
///
/// \param needReload If <code>true</code>, the table view will call <code>reloadData()</code>.
///
- (void)deleteResendableMessage:(SBDBaseMessage * _Nonnull)message needReload:(BOOL)needReload;
...
@interface SBUBaseChannelViewController (SWIFT_EXTENSION(SendBirdUIKit)) <SBUSelectablePhotoViewDelegate>
- (void)didTapSendImageData:(NSData * _Nonnull)data;
- (void)didTapSendVideoURL:(NSURL * _Nonnull)url;
@end
...
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
/// Set up gestures on the <code>messageCell</code> with <code>message</code>.
/// since:
/// 2.2.8
- (void)setMessageCellGesture:(SBUBaseMessageCell * _Nonnull)messageCell message:(SBDBaseMessage * _Nonnull)message;
...
/// A stack view that contains <code>fileImageview</code> and <code>fileNameLabel</code> as defaults.
...
///
+ (void)initializeWithApplicationId:(NSString * _Nonnull)applicationId SWIFT_UNAVAILABLE_MSG("'initialize' has been renamed to 'initializeWithApplicationId:startHandler:migrationHandler:completionHandler:': Using the `initialize(applicationId:startHandler:migrationHandler:completionHandler:)` function, and in the CompletionHandler, please proceed with the following procedure.");
+ (void)initializeWithApplicationId:(NSString * _Nonnull)applicationId migrationStartHandler:(void (^ _Nonnull)(void))migrationStartHandler completionHandler:(void (^ _Nonnull)(SBDError * _Nullable))completionHandler SWIFT_DEPRECATED_MSG("", "initializeWithApplicationId:startHandler:migrationHandler:completionHandler:");
/// This function is used to initializes SDK with applicationId.
...
/// \param applicationId Application ID
///
/// \param startHandler Do something to display the start of the SendbirdChat initialization.
///
/// \param migrationHandler Do something to display the progress of the DB migration.
///
/// \param completionHandler Do something to display the completion of the DB migration.
///
+ (void)initializeWithApplicationId:(NSString * _Nonnull)applicationId startHandler:(void (^ _Nullable)(void))startHandler migrationHandler:(void (^ _Nullable)(void))migrationHandler completionHandler:(void (^ _Nonnull)(SBDError * _Nullable))completionHandler;
...
///
/// \param rootViewController If you use a complex hierarchy structure, ㄴet your ChannelList or Channel ViewController here.
///
+ (void)moveToChannelWithChannelUrl:(NSString * _Nonnull)channelUrl basedOnChannelList:(BOOL)basedOnChannelList messageListParams:(SBDMessageListParams * _Nullable)messageListParams channelType:(enum ChannelType)channelType rootViewController:(UIViewController * _Nullable)rootViewController;
...
- (void)setupAutolayout;
- (void)setupStyles;
- (void)configureWithTimestamp:(int64_t)timestamp;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface SBUMessageReactionView : UIView <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER SWIFT_UNAVAILABLE_MSG("'init' has been renamed to 'MessageReactionView()'");
...
/// since:
/// 2.1.13
@property (nonatomic, readonly, copy) NSString * _Nonnull timeFormat SWIFT_DEPRECATED_MSG("", "SBUDateFormatSet.Message.sentTimeFormat");
...
typedef SWIFT_ENUM_NAMED(NSInteger, SBUPhotoAccessLevel, "SBUPhotoAccessLevel", open) {
/// Only able to add a new photo to the library
  SBUPhotoAccessLevelAddOnly = 0,
/// Get photo from the library as well as add a new photo.
  SBUPhotoAccessLevelReadWrite = 1,
};

typedef SWIFT_ENUM_NAMED(NSInteger, SBUPhotoAccessibleStatus, "SBUPhotoAccessibleStatus", open) {
  SBUPhotoAccessibleStatusAll = 0,
  SBUPhotoAccessibleStatusLimited = 1,
  SBUPhotoAccessibleStatusNotDetermined = 2,
  SBUPhotoAccessibleStatusRestricted = 3,
  SBUPhotoAccessibleStatusDenied = 4,
  SBUPhotoAccessibleStatusNone = 5,
};
...
@property (nonatomic, strong) UIImageView * _Nonnull iconImageView;
/// The object that is used as a theme. The theme inherits from <code>SBUMessageCellTheme</code>.
@property (nonatomic, strong) SBUMessageCellTheme * _Nonnull theme;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
- (void)layoutSubviews;
...
- (void)configureWithImage:(UIImage * _Nullable)image forMediaType:(PHAssetMediaType)mediaType;
/// This function handles the initialization of styles.
- (void)setupStyles;
@end
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSString * _Nonnull ViewLibrary;)
+ (NSString * _Nonnull)ViewLibrary SWIFT_WARN_UNUSED_RESULT;
+ (void)setViewLibrary:(NSString * _Nonnull)value;
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSString * _Nonnull Settings;)
+ (NSString * _Nonnull)Settings SWIFT_WARN_UNUSED_RESULT;
+ (void)setSettings:(NSString * _Nonnull)value;
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSString * _Nonnull Alert_Allow_PhotoLibrary_Access;)
+ (NSString * _Nonnull)Alert_Allow_PhotoLibrary_Access SWIFT_WARN_UNUSED_RESULT;
+ (void)setAlert_Allow_PhotoLibrary_Access:(NSString * _Nonnull)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSString * _Nonnull Alert_Allow_PhotoLibrary_Access_Message;)
+ (NSString * _Nonnull)Alert_Allow_PhotoLibrary_Access_Message SWIFT_WARN_UNUSED_RESULT;
+ (void)setAlert_Allow_PhotoLibrary_Access_Message:(NSString * _Nonnull)value;
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSString * _Nonnull (^ _Nonnull InviteChannel_Register)(NSInteger);)
+ (NSString * _Nonnull (^ _Nonnull)(NSInteger))InviteChannel_Register SWIFT_WARN_UNUSED_RESULT;
+ (void)setInviteChannel_Register:(NSString * _Nonnull (^ _Nonnull)(NSInteger))value;
...
@interface SBUStringSet (SWIFT_EXTENSION(SendBirdUIKit))
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSString * _Nonnull (^ _Nonnull InviteChannel_Add)(NSInteger) SWIFT_DEPRECATED_MSG("", "InviteChannel_Register");)
