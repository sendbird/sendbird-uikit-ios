...
@interface CategoryFilter : UIView
...
@interface CategoryFilter (SWIFT_EXTENSION(SendbirdUIKit)) <UICollectionViewDelegate>
- (void)collectionView:(UICollectionView * _Nonnull)collectionView didSelectItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
@end

@class UICollectionViewCell;

@interface CategoryFilter (SWIFT_EXTENSION(SendbirdUIKit)) <UICollectionViewDataSource>
...
@interface CategoryFilter (SWIFT_EXTENSION(SendbirdUIKit)) <UICollectionViewDelegateFlowLayout>
...
/// A module component that represent the header of <code>SBUModerationsModule</code>.
/// <ul>
///   <li>
///     This class consists of titleView, leftBarButton, leftBarButtons, rightBarButton and rightBarButtons.
///   </li>
/// </ul>
SWIFT_CLASS("_TtCC13SendbirdUIKit20SBUModerationsModule6Header")
@interface Header : UIView
/// A view that represents a title in navigation bar.
/// The defaults view type is <code>SBUNavigationTitleView</code>.
/// note:
/// When the value is updated, <code>moderationsModule(_:didUpdateTitleView:)</code> delegate function is called.
@property (nonatomic, strong) UIView * _Nullable titleView;
/// A view that represents a left <code>UIBarButtonItem</code> in navigation bar.
/// note:
/// When the value is updated, <code>moderationsModule(_:didUpdateLeftItem:)</code> delegate function is called.
/// and when the value is tapped, <code>moderationsModule(_:didTapLeftItem:)</code> delegate function is called.
@property (nonatomic, strong) UIBarButtonItem * _Nullable leftBarButton;
/// A view that represents a right <code>UIBarButtonItem</code> in navigation bar.
/// note:
/// When the value is updated, <code>moderationsModule(_:didUpdateRightItem:)</code> delegate function is called.
@property (nonatomic, strong) UIBarButtonItem * _Nullable rightBarButton;
/// A view that represents the left <code>UIBarButtonItem</code>s in navigation bar.
/// note:
/// When the value is updated, <code>moderationsModule(_:didUpdateLeftItem:)</code> delegate function is called.
/// and when the value is tapped, <code>moderationsModule(_:didTapLeftItems:)</code> delegate function is called.
/// since:
/// 3.28.0
@property (nonatomic, copy) NSArray<UIBarButtonItem *> * _Nullable leftBarButtons;
/// A view that represents the right <code>UIBarButtonItem</code>s in navigation bar.
/// note:
/// When the value is updated, <code>moderationsModule(_:didUpdateRightItems:)</code> delegate function is called.
/// since:
/// 3.28.0
@property (nonatomic, copy) NSArray<UIBarButtonItem *> * _Nullable rightBarButtons;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER SWIFT_UNAVAILABLE_MSG("'init' has been renamed to 'SBUModerationsModule.Header()'");
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER SWIFT_UNAVAILABLE_MSG("'init' has been renamed to 'SBUModerationsModule.Header()'");
/// Set values of the views in the header component when it needs.
/// note:
/// If you want to implement <code>rightBarButton</code>, set your custom button here.
- (void)setupViews;
/// Sets layouts of the views in the header component.
- (void)setupLayouts;
/// The action of <code>leftBarButton</code>. It calls <code>moderationsModule(_:didTapLeftItem:)</code> when it’s tapped
- (void)onTapLeftBarButton;
@end

@class SBUBarButtonItem;
@class SBUNavigationTitleView;

@interface Header (SWIFT_EXTENSION(SendbirdUIKit))
/// Represents the metatype of left bar button in <code>SBUModerationsModule.Header</code>.
/// since:
/// 3.28.0
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) SWIFT_METATYPE(SBUBarButtonItem) _Nonnull LeftBarButton;)
+ (SWIFT_METATYPE(SBUBarButtonItem) _Nonnull)LeftBarButton SWIFT_WARN_UNUSED_RESULT;
+ (void)setLeftBarButton:(SWIFT_METATYPE(SBUBarButtonItem) _Nonnull)value;
/// Represents the metatype of title view in <code>SBUModerationsModule.Header</code>.
/// since:
/// 3.28.0
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) SWIFT_METATYPE(SBUNavigationTitleView) _Nonnull TitleView;)
+ (SWIFT_METATYPE(SBUNavigationTitleView) _Nonnull)TitleView SWIFT_WARN_UNUSED_RESULT;
+ (void)setTitleView:(SWIFT_METATYPE(SBUNavigationTitleView) _Nonnull)value;
@end

@class SBUUser;

/// A module component that represent the header of <code>SBUBaseSelectUserModule</code>.
SWIFT_CLASS("_TtCC13SendbirdUIKit23SBUBaseSelectUserModule6Header")
@interface Header : UIView
/// A view that represents a title in navigation bar.
/// The default view type is <code>SBUNavigationTitleView</code>.
/// note:
/// When the value is updated, <code>didUpdateTitleView</code>is called.
@property (nonatomic, strong) UIView * _Nullable titleView;
/// A view that represents a left <code>UIBarButtonItem</code> in navigation bar.
/// note:
/// When the value is updated, <code>didUpdateLeftItem</code>is called.
@property (nonatomic, strong) UIBarButtonItem * _Nullable leftBarButton;
/// A view that represents a right <code>UIBarButtonItem</code> in navigation bar.
/// note:
/// When the value is updated, <code>didUpdateRightItem</code>is called.
@property (nonatomic, strong) UIBarButtonItem * _Nullable rightBarButton;
/// A view that represents a left <code>UIBarButtonItem</code> in navigation bar.
/// note:
/// When the value is updated, <code>didUpdateLeftItem</code>is called.
...
/// Sets layouts of the views in the header component.
- (void)setupLayouts;
/// Updates right bar button based on <code>selectedUserList.count</code>. The defaults action is updating the title of the button and the tint color with <code>rightBarButtonTintColor</code> and <code>rightBarButtonSelectedTintColor</code> from the <code>theme</code>.
- (void)updateRightBarButton;
/// The action of the <code>leftBarButton</code>.
- (void)onTapLeftBarButton;
/// The action of the <code>rightBarButton</code>.
...
/// A module component that represent the header of <code>SBUCreateChannelModule</code>.
/// This class consists of titleView, leftBarButton, and rightBarButton.
SWIFT_CLASS("_TtCC13SendbirdUIKit22SBUCreateChannelModule6Header")
@interface Header : Header
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER SWIFT_UNAVAILABLE_MSG("'init' has been renamed to 'SBUCreateChannelModule.Header()'");
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER SWIFT_UNAVAILABLE_MSG("'init' has been renamed to 'SBUCreateChannelModule.Header()'");
- (void)setupViews;
- (void)updateRightBarButton;
- (void)didUpdateTitleView;
- (void)didUpdateLeftItem;
- (void)didUpdateRightItem;
- (void)didUpdateLeftItems;
- (void)didUpdateRightItems;
/// The action of the leftBarButton. It calls <code>createChannelModule(_:didTapLeftItem:)</code> delegate method.
- (void)onTapLeftBarButton;
/// The action of the rightBarButton. It calls <code>createChannelModule(_:didTapRightItem:)</code> delegate method.
- (void)onTapRightBarButton;
@end


@interface Header (SWIFT_EXTENSION(SendbirdUIKit))
/// Represents the metatype of left bar button in <code>SBUCreateChannelModule.Header</code>.
/// since:
/// 3.28.0
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) SWIFT_METATYPE(SBUBarButtonItem) _Nonnull LeftBarButton;)
+ (SWIFT_METATYPE(SBUBarButtonItem) _Nonnull)LeftBarButton SWIFT_WARN_UNUSED_RESULT;
+ (void)setLeftBarButton:(SWIFT_METATYPE(SBUBarButtonItem) _Nonnull)value;
/// Represents the metatype of title view in <code>SBUCreateChannelModule.Header</code>.
/// since:
/// 3.28.0
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) SWIFT_METATYPE(SBUNavigationTitleView) _Nonnull TitleView;)
+ (SWIFT_METATYPE(SBUNavigationTitleView) _Nonnull)TitleView SWIFT_WARN_UNUSED_RESULT;
+ (void)setTitleView:(SWIFT_METATYPE(SBUNavigationTitleView) _Nonnull)value;
/// Represents the metatype of right bar button in <code>SBUCreateChannelModule.Header</code>.
/// since:
/// 3.28.0
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) SWIFT_METATYPE(SBUBarButtonItem) _Nonnull RightBarButton;)
+ (SWIFT_METATYPE(SBUBarButtonItem) _Nonnull)RightBarButton SWIFT_WARN_UNUSED_RESULT;
+ (void)setRightBarButton:(SWIFT_METATYPE(SBUBarButtonItem) _Nonnull)value;
@end


/// A module component that represent the header of <code>SBUCreateOpenChannelModule</code>.
/// This class consists of titleView, leftBarButton, and rightBarButton.
SWIFT_CLASS("_TtCC13SendbirdUIKit26SBUCreateOpenChannelModule6Header")
@interface Header : UIView
/// A view that represents a title in navigation bar.
/// The default view type is <code>SBUNavigationTitleView</code>.
/// note:
/// When the value is updated, <code>createOpenChannelModule(_:didUpdateTitleView:)</code> delegate function is called.
@property (nonatomic, strong) UIView * _Nullable titleView;
/// A view that represents a left <code>UIBarButtonItem</code> in navigation bar.
/// note:
/// When the value is updated, <code>createOpenChannelModule(_:didUpdateLeftItem:)</code> delegate function is called.
/// and when the value is tapped, <code>createOpenChannelModule(_:didTapLeftItem:)</code> delegate function is called.
@property (nonatomic, strong) UIBarButtonItem * _Nullable leftBarButton;
/// A view that represents a right <code>UIBarButtonItem</code> in navigation bar.
/// note:
/// When the value is updated, <code>createOpenChannelModule(_:didUpdateRightItem:)</code> delegate function is called.
@property (nonatomic, strong) UIBarButtonItem * _Nullable rightBarButton;
/// A view that represents the left <code>UIBarButtonItem</code>s in navigation bar.
/// note:
/// When the value is updated, <code>createOpenChannelModule(_:didUpdateLeftItems:)</code> delegate function is called.
/// and when the value is tapped, <code>createOpenChannelModule(_:didTapLeftItems:)</code> delegate function is called.
/// since:
/// 3.28.0
@property (nonatomic, copy) NSArray<UIBarButtonItem *> * _Nullable leftBarButtons;
/// A view that represents the right <code>UIBarButtonItem</code>s in navigation bar.
/// note:
/// When the value is updated, <code>createOpenChannelModule(_:didUpdateRightItems:)</code> delegate function is called.
/// since:
/// 3.28.0
@property (nonatomic, copy) NSArray<UIBarButtonItem *> * _Nullable rightBarButtons;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER SWIFT_UNAVAILABLE_MSG("'init' has been renamed to 'SBUCreateOpenChannelModule.Header()'");
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER SWIFT_UNAVAILABLE_MSG("'init' has been renamed to 'SBUCreateOpenChannelModule.Header()'");
/// Set values of the views in the header component when it needs.
/// note:
/// If you want to implement <code>rightBarButton</code>, set your custom button here.
- (void)setupViews;
/// Sets layouts of the views in the header component.
- (void)setupLayouts;
/// Updates right bar button. The defaults action is updating the title of the button and the tint color with <code>rightBarButtonTintColor</code> and <code>rightBarButtonDisabledTintColor</code> from the <code>theme</code>.
- (void)enableRightBarButton:(BOOL)enabled;
/// The action of the leftBarButton. It calls <code>createOpenChannelModule(_:didTapLeftItem:)</code> delegate method.
- (void)onTapLeftBarButton;
/// The action of the rightBarButton. It calls <code>createOpenChannelModule(_:didTapRightItem:)</code> delegate method.
- (void)onTapRightBarButton;
@end


@interface Header (SWIFT_EXTENSION(SendbirdUIKit))
/// Represents the metatype of left bar button in <code>SBUCreateOpenChannelModule.Header</code>.
/// since:
/// 3.28.0
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) SWIFT_METATYPE(SBUBarButtonItem) _Nonnull LeftBarButton;)
+ (SWIFT_METATYPE(SBUBarButtonItem) _Nonnull)LeftBarButton SWIFT_WARN_UNUSED_RESULT;
+ (void)setLeftBarButton:(SWIFT_METATYPE(SBUBarButtonItem) _Nonnull)value;
/// Represents the metatype of title view in <code>SBUCreateOpenChannelModule.Header</code>.
/// since:
/// 3.28.0
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) SWIFT_METATYPE(SBUNavigationTitleView) _Nonnull TitleView;)
+ (SWIFT_METATYPE(SBUNavigationTitleView) _Nonnull)TitleView SWIFT_WARN_UNUSED_RESULT;
+ (void)setTitleView:(SWIFT_METATYPE(SBUNavigationTitleView) _Nonnull)value;
/// Represents the metatype of right bar button in <code>SBUCreateOpenChannelModule.Header</code>.
/// since:
/// 3.28.0
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) SWIFT_METATYPE(SBUBarButtonItem) _Nonnull RightBarButton;)
+ (SWIFT_METATYPE(SBUBarButtonItem) _Nonnull)RightBarButton SWIFT_WARN_UNUSED_RESULT;
...
/// A module component that represents the header of <code>SBUBaseChannelListModule</code>.
SWIFT_CLASS("_TtCC13SendbirdUIKit24SBUBaseChannelListModule6Header")
@interface Header : UIView
/// A view that represents a title in navigation bar.
/// The default view type is <code>SBUNavigationTitleView</code>.
/// note:
/// When the value is updated, <code>channelListModule(_:didUpdateTitleView:)</code> delegate function is called.
@property (nonatomic, strong) UIView * _Nullable titleView;
/// A view that represents a left <code>UIBarButtonItem</code> in navigation bar.
/// note:
/// When the value is updated, <code>channelListModule(_:didUpdateLeftItem:)</code> delegate function is called
@property (nonatomic, strong) UIBarButtonItem * _Nullable leftBarButton;
/// A view that represents a right <code>UIBarButtonItem</code> in navigation bar.
/// note:
/// When the value is updated, <code>channelListModule(_:didUpdateRightItem:)</code> delegate function is called.
@property (nonatomic, strong) UIBarButtonItem * _Nullable rightBarButton;
/// A view that represents the left <code>[UIBarButtonItem]</code> in the navigation bar.
/// note:
/// When the value is updated, <code>channelListModule(_:didUpdateLeftItems:)</code> delegate function is called.
/// since:
/// 3.28.0
@property (nonatomic, copy) NSArray<UIBarButtonItem *> * _Nullable leftBarButtons;
/// A view that represents the right <code>[UIBarButtonItem]</code> in the navigation bar.
/// note:
/// When the value is updated, <code>channelListModule(_:didUpdateRightItems:)</code> delegate function is called.
/// since:
/// 3.28.0
@property (nonatomic, copy) NSArray<UIBarButtonItem *> * _Nullable rightBarButtons;
...
/// Sets layouts of the views in the header component.
- (void)setupLayouts;
/// Called when the <code>leftBarButton</code> was tapped.
- (void)onTapLeftBarButton;
/// Called when the <code>rightBarButton</code> was tapped.
- (void)onTapRightBarButton;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
/// A module component that represents the header of <code>SBUGroupChannelListModule</code>.
SWIFT_CLASS("_TtCC13SendbirdUIKit25SBUGroupChannelListModule6Header")
@interface Header : Header
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER SWIFT_UNAVAILABLE_MSG("'init' has been renamed to 'SBUGroupChannelListModule.Header()'");
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER SWIFT_UNAVAILABLE_MSG("'init' has been renamed to 'SBUGroupChannelListModule.Header()'");
- (void)setupViews;
@end
...
/// A module component that represent the header of <code>SBUBaseChannelModule</code>.
SWIFT_CLASS("_TtCC13SendbirdUIKit20SBUBaseChannelModule6Header")
@interface Header : UIView
/// A view that represents a title in navigation bar.
/// For <code>SBUBaseChannelModule.Header</code> and its subclasses, the default view type is <code>SBUChannelTitleView</code>.
/// For <code>SBUMessageThreadModule.Header</code>, the default view type is <code>SBUMessageThreadTitleView</code>.
/// note:
/// When the value is updated, <code>baseChannelModule(_:didUpdateTitleView:)</code> delegate function is called.
@property (nonatomic, strong) UIView * _Nullable titleView;
/// A view that represents a left <code>UIBarButtonItem</code> in navigation bar.
/// The default view type is <code>UIBarButtonItem</code>.
/// note:
/// When the value is updated, <code>baseChannelModule(_:didUpdateLeftItem:)</code> delegate function is called.
@property (nonatomic, strong) UIBarButtonItem * _Nullable leftBarButton;
/// A view that represents a right <code>UIBarButtonItem</code> in navigation bar.
/// For <code>SBUOpenChannelModule.Header</code>, the default view type is <code>UIBarButtonItem</code>.
/// note:
/// When the value is updated, <code>baseChannelModule(_:didUpdateRightItem:)</code> delegate function is called.
@property (nonatomic, strong) UIBarButtonItem * _Nullable rightBarButton;
/// A view that represents left bar items in navigation bar.
/// since:
/// 3.28.0
/// note:
/// When the value is updated, <code>baseChannelModule(_:didUpdateLeftItems:)</code> delegate function is called.
@property (nonatomic, copy) NSArray<UIBarButtonItem *> * _Nullable leftBarButtons;
/// A view that represents right bar items in navigation bar.
/// since:
/// 3.28.0
/// note:
/// When the value is updated, <code>baseChannelModule(_:didUpdateRightItems:)</code> delegate function is called.
@property (nonatomic, copy) NSArray<UIBarButtonItem *> * _Nullable rightBarButtons;
@property (nonatomic, strong) UIView * _Nonnull titleSpacer;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER SWIFT_UNAVAILABLE_MSG("'init' has been renamed to 'SBUBaseChannelModule.Header()'");
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER SWIFT_UNAVAILABLE_MSG("'init' has been renamed to 'SBUBaseChannelModule.Header()'");
/// Set values of the views in the header component when it needs.
- (void)setupViews;
/// Sets layouts of the views in the header component.
- (void)setupLayouts;
/// The action of <code>leftBarButton</code>. It calls <code>baseChannelModule(_:didTapLeftItem:)</code> when it’s tapped
- (void)onTapLeftBarButton;
/// The action of <code>rightBarButton</code>. It calls <code>baseChannelModule(_:didTapRightItem:)</code> when it’s tapped
- (void)onTapRightBarButton;
@end


/// A module component that represent the header of <code>SBUGroupChannelModule</code>.
SWIFT_CLASS("_TtCC13SendbirdUIKit21SBUGroupChannelModule6Header")
@interface Header : Header
- (void)setupViews;
- (void)onTapLeftBarButton;
- (void)onTapRightBarButton;
...
/// since:
/// 3.28.0
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) SWIFT_METATYPE(SBUChannelTitleView) _Nonnull TitleView;)
+ (SWIFT_METATYPE(SBUChannelTitleView) _Nonnull)TitleView SWIFT_WARN_UNUSED_RESULT;
+ (void)setTitleView:(SWIFT_METATYPE(SBUChannelTitleView) _Nonnull)value;
@end


/// A module component that represent the header of <code>SBUGroupChannelPushSettingsModule</code>.
SWIFT_CLASS("_TtCC13SendbirdUIKit33SBUGroupChannelPushSettingsModule6Header")
@interface Header : UIView
/// A view that represents a title in navigation bar.
/// The default view type is <code>SBUNavigationTitleView</code>.
/// note:
/// When the value is updated, <code>groupChannelPushSettingsModule(_:didUpdateTitleView:)</code> delegate function is called.
@property (nonatomic, strong) UIView * _Nullable titleView;
/// A view that represents a left <code>UIBarButtonItem</code> in navigation bar.
/// The default view type is <code>UIBarButtonItem</code>.
/// note:
/// When the value is updated, <code>groupChannelPushSettingsModule(_:didUpdateLeftItem:)</code> delegate function is called.
/// and when the value is tapped, <code>groupChannelPushSettingsModule(_:didTapLeftItem:)</code> delegate function is called.
@property (nonatomic, strong) UIBarButtonItem * _Nullable leftBarButton;
/// A view that represents a right <code>UIBarButtonItem</code> in navigation bar.
/// note:
/// When the value is updated, <code>groupChannelPushSettingsModule(_:didUpdateRightItem:)</code> delegate function is called.
/// and when the value is tapped, <code>groupChannelPushSettingsModule(_:didTapRightItem:)</code> delegate function is called.
@property (nonatomic, strong) UIBarButtonItem * _Nullable rightBarButton;
/// A view that represents the left <code>[UIBarButtonItem]</code> in navigation bar.
/// The default view type is <code>[UIBarButtonItem]</code>.
/// note:
/// When the value is updated, <code>groupChannelPushSettingsModule(_:didUpdateLeftItems:)</code> delegate function is called.
/// and when the default <code>leftBarButtons</code> is tapped, <code>groupChannelPushSettingsModule(_:didTapLeftItem:)</code> delegate function is called.
/// since:
/// 3.28.0
@property (nonatomic, copy) NSArray<UIBarButtonItem *> * _Nullable leftBarButtons;
/// A view that represents the right <code>[UIBarButtonItem]</code> in navigation bar.
/// note:
/// When the value is updated, <code>groupChannelPushSettingsModule(_:didUpdateRightItems:)</code> delegate function is called.
/// and when the default <code>rightBarButtons</code> is tapped, <code>groupChannelPushSettingsModule(_:didTapRightItem:)</code> delegate function is called.
/// since:
/// 3.28.0
@property (nonatomic, copy) NSArray<UIBarButtonItem *> * _Nullable rightBarButtons;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER SWIFT_UNAVAILABLE_MSG("'init' has been renamed to 'SBUGroupChannelPushSettingsModule.Header()'");
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER SWIFT_UNAVAILABLE_MSG("'init' has been renamed to 'SBUGroupChannelPushSettingsModule.Header()'");
/// Set values of the views in the header component when it needs.
/// \code
/// // Override guidance
...
/// Sets layouts of the views in the header component.
- (void)setupLayouts;
/// The action of <code>leftBarButton</code>. It calls <code>groupChannelPushSettingsModule(_:didTapLeftItem:)</code> when it’s tapped
- (void)onTapLeftBarButton;
/// The action of <code>rightBarButton</code>. It calls <code>groupChannelPushSettingsModule(_:didTapRightItem:)</code> when it’s tapped
- (void)onTapRightBarButton;
@end
...
/// A module component that represent the header of <code>SBUBaseChannelSettingsModule</code>.
SWIFT_CLASS("_TtCC13SendbirdUIKit28SBUBaseChannelSettingsModule6Header")
@interface Header : UIView
/// A view that represents a title in navigation bar.
/// The default view type is <code>SBUNavigationTitleView</code>.
/// note:
...
/// A module component that represent the header of <code>SBUGroupChannelSettingsModule</code>.
/// <ul>
///   <li>
///     This class consists of titleView, leftBarButton, and rightBarButton.
///   </li>
/// </ul>
SWIFT_CLASS("_TtCC13SendbirdUIKit29SBUGroupChannelSettingsModule6Header")
@interface Header : Header
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER SWIFT_UNAVAILABLE_MSG("'init' has been renamed to 'SBUGroupChannelSettingsModule.Header()'");
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER SWIFT_UNAVAILABLE_MSG("'init' has been renamed to 'SBUGroupChannelSettingsModule.Header()'");
- (void)setupViews;
- (void)didUpdateTitleView;
- (void)didUpdateLeftItem;
- (void)didUpdateRightItem;
...
/// A module component that represent the header of <code>SBUInviteUserModule</code>.
/// This class consists of titleView, leftBarButton, and rightBarButton.
SWIFT_CLASS("_TtCC13SendbirdUIKit19SBUInviteUserModule6Header")
@interface Header : Header
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER SWIFT_UNAVAILABLE_MSG("'init' has been renamed to 'SBUInviteUserModule.Header()'");
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER SWIFT_UNAVAILABLE_MSG("'init' has been renamed to 'SBUInviteUserModule.Header()'");
- (void)setupViews;
- (void)updateRightBarButton;
- (void)didUpdateTitleView;
- (void)didUpdateLeftItem;
...
@interface Header (SWIFT_EXTENSION(SendbirdUIKit))
/// Represents the metatype of left bar button in <code>SBUInviteUserModule.Header</code>.
/// since:
/// 3.28.0
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) SWIFT_METATYPE(SBUBarButtonItem) _Nonnull LeftBarButton;)
+ (SWIFT_METATYPE(SBUBarButtonItem) _Nonnull)LeftBarButton SWIFT_WARN_UNUSED_RESULT;
+ (void)setLeftBarButton:(SWIFT_METATYPE(SBUBarButtonItem) _Nonnull)value;
/// Represents the metatype of title view in <code>SBUInviteUserModule.Header</code>.
/// since:
/// 3.28.0
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) SWIFT_METATYPE(SBUNavigationTitleView) _Nonnull TitleView;)
+ (SWIFT_METATYPE(SBUNavigationTitleView) _Nonnull)TitleView SWIFT_WARN_UNUSED_RESULT;
+ (void)setTitleView:(SWIFT_METATYPE(SBUNavigationTitleView) _Nonnull)value;
/// Represents the metatype of right bar button in <code>SBUInviteUserModule.Header</code>.
/// since:
/// 3.28.0
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) SWIFT_METATYPE(SBUBarButtonItem) _Nonnull RightBarButton;)
+ (SWIFT_METATYPE(SBUBarButtonItem) _Nonnull)RightBarButton SWIFT_WARN_UNUSED_RESULT;
...
/// A module component that represent the header of <code>SBUUserListModule</code>.
SWIFT_CLASS("_TtCC13SendbirdUIKit17SBUUserListModule6Header")
@interface Header : UIView
/// A view that represents a title in navigation bar.
/// The default view type is <code>SBUNavigationTitleView</code>.
/// note:
/// When the value is updated, <code>userListModule(_:didUpdateTitleView:)</code> delegate function is called.
@property (nonatomic, strong) UIView * _Nullable titleView;
/// A view that represents a left <code>UIBarButtonItem</code> in navigation bar.
/// note:
/// When the value is updated, <code>userListModule(_:didUpdateLeftItem:)</code> delegate function is called.
/// and when the value is tapped, <code>userListModule(_:didTapLeftItem:)</code> delegate function is called.
@property (nonatomic, strong) UIBarButtonItem * _Nullable leftBarButton;
/// A view that represents a right <code>UIBarButtonItem</code> in navigation bar.
/// note:
/// When the value is updated, <code>userListModule(_:didUpdateRightItem:)</code> delegate function is called.
/// and when the value is tapped, <code>userListModule(_:didTapRightItem:)</code> delegate function is called.
@property (nonatomic, strong) UIBarButtonItem * _Nullable rightBarButton;
/// A view that represents a left <code>UIBarButtonItem</code> in navigation bar.
/// note:
/// When the value is updated, <code>userListModule(_:didUpdateLeftItems:)</code> delegate function is called.
/// and when the value is tapped, <code>userListModule(_:didTapLeftItem:)</code> delegate function is called.
/// since:
/// 3.28.0
@property (nonatomic, copy) NSArray<UIBarButtonItem *> * _Nullable leftBarButtons;
/// A view that represents a right <code>UIBarButtonItem</code> in navigation bar.
/// note:
/// When the value is updated, <code>userListModule(_:didUpdateRightItems:)</code> delegate function is called.
/// and when the value is tapped, <code>userListModule(_:didTapRightItem:)</code> delegate function is called.
/// since:
/// 3.28.0
@property (nonatomic, copy) NSArray<UIBarButtonItem *> * _Nullable rightBarButtons;
...
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER SWIFT_UNAVAILABLE_MSG("'init' has been renamed to 'SBUUserListModule.Header()'");
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER SWIFT_UNAVAILABLE_MSG("'init' has been renamed to 'SBUUserListModule.Header()'");
/// Set values of the views in the header component when it needs.
- (void)setupViews;
/// Sets layouts of the views in the header component.
- (void)setupLayouts;
/// The action of <code>leftBarButton</code>. It calls <code>userListModule(_:didTapLeftItem:)</code> when it’s tapped
- (void)onTapLeftBarButton;
/// The action of <code>rightBarButton</code>. It calls <code>userListModule(_:didTapRightItem:)</code> when it’s tapped
- (void)onTapRightBarButton;
@end


@interface Header (SWIFT_EXTENSION(SendbirdUIKit))
/// Represents the metatype of left bar button in <code>SBUUserListModule.Header</code>.
/// since:
/// 3.28.0
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) SWIFT_METATYPE(SBUBarButtonItem) _Nonnull LeftBarButton;)
+ (SWIFT_METATYPE(SBUBarButtonItem) _Nonnull)LeftBarButton SWIFT_WARN_UNUSED_RESULT;
+ (void)setLeftBarButton:(SWIFT_METATYPE(SBUBarButtonItem) _Nonnull)value;
/// Represents the metatype of title view in <code>SBUUserListModule.Header</code>.
/// since:
/// 3.28.0
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) SWIFT_METATYPE(SBUNavigationTitleView) _Nonnull TitleView;)
+ (SWIFT_METATYPE(SBUNavigationTitleView) _Nonnull)TitleView SWIFT_WARN_UNUSED_RESULT;
+ (void)setTitleView:(SWIFT_METATYPE(SBUNavigationTitleView) _Nonnull)value;
/// Represents the metatype of right bar button in <code>SBUUserListModule.Header</code>.
/// since:
/// 3.28.0
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) SWIFT_METATYPE(SBUBarButtonItem) _Nonnull RightBarButton;)
+ (SWIFT_METATYPE(SBUBarButtonItem) _Nonnull)RightBarButton SWIFT_WARN_UNUSED_RESULT;
...
@class SBUMessageThreadTitleView;

/// A module component that represent the header of <code>SBUMessageThreadModule</code>.
SWIFT_CLASS("_TtCC13SendbirdUIKit22SBUMessageThreadModule6Header")
@interface Header : Header
...
- (void)onTapTitleView;
- (void)onTapLeftBarButton;
- (void)messageThreadTitleViewDidTap:(SBUMessageThreadTitleView * _Nonnull)messageThreadTitleView;
@end
...
/// since:
/// 3.28.0
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) SWIFT_METATYPE(SBUMessageThreadTitleView) _Nonnull TitleView;)
+ (SWIFT_METATYPE(SBUMessageThreadTitleView) _Nonnull)TitleView SWIFT_WARN_UNUSED_RESULT;
+ (void)setTitleView:(SWIFT_METATYPE(SBUMessageThreadTitleView) _Nonnull)value;
@end


/// A module component that represents the header of <code>SBUOpenChannelListModule</code>.
SWIFT_CLASS("_TtCC13SendbirdUIKit24SBUOpenChannelListModule6Header")
@interface Header : Header
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER SWIFT_UNAVAILABLE_MSG("'init' has been renamed to 'SBUOpenChannelListModule.Header()'");
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER SWIFT_UNAVAILABLE_MSG("'init' has been renamed to 'SBUOpenChannelListModule.Header()'");
- (void)setupViews;
@end
...
/// A module component that represent the header of <code>SBUOpenChannelModule</code>.
SWIFT_CLASS("_TtCC13SendbirdUIKit20SBUOpenChannelModule6Header")
@interface Header : Header
/// A view that shows the information of the open channel such as a cover image, a channel name and a description.
@property (nonatomic, strong) UIView * _Nonnull channelInfoView;
/// A property to hide <code>channelInfoView</code>.
@property (nonatomic) BOOL hidesChannelInfoView;
@property (nonatomic) BOOL overlaysChannelInfoView;
@property (nonatomic, strong) UIBarButtonItem * _Nullable rightBarButton;
/// A view that represents right bar items in navigation bar.
/// since:
/// 3.28.0
...
/// \param overlaid When the it’s on overlaying mode, assign <code>true</code> for this parameter. The default value is <code>false</code>.
///
- (void)updateStylesWithOverlaid:(BOOL)overlaid;
/// Updates the right bar button item / items with operator status of the current user.
- (void)updateBarButtonWithIsOperator:(BOOL)isOperator;
...
/// A module component that represent the header of <code>SBUOpenChannelSettingsModule</code>.
/// <ul>
///   <li>
///     This class consists of titleView, leftBarButton, and rightBarButton.
///   </li>
/// </ul>
SWIFT_CLASS("_TtCC13SendbirdUIKit28SBUOpenChannelSettingsModule6Header")
@interface Header : Header
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER SWIFT_UNAVAILABLE_MSG("'init' has been renamed to 'SBUOpenChannelSettingsModule.Header()'");
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER SWIFT_UNAVAILABLE_MSG("'init' has been renamed to 'SBUOpenChannelSettingsModule.Header()'");
- (void)setupViews;
- (void)didUpdateTitleView;
- (void)didUpdateLeftItem;
- (void)didUpdateRightItem;
...
/// A module component that represent the header of <code>SBURegisterOperatorModule</code>.
/// This class consists of titleView, leftBarButton, and rightBarButton.
SWIFT_CLASS("_TtCC13SendbirdUIKit25SBURegisterOperatorModule6Header")
@interface Header : Header
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER SWIFT_UNAVAILABLE_MSG("'init' has been renamed to 'SBURegisterOperatorModule.Header()'");
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER SWIFT_UNAVAILABLE_MSG("'init' has been renamed to 'SBURegisterOperatorModule.Header()'");
- (void)setupViews;
- (void)updateRightBarButton;
- (void)didUpdateTitleView;
- (void)didUpdateLeftItem;
...
@interface Header (SWIFT_EXTENSION(SendbirdUIKit))
/// Represents the metatype of left bar button in <code>SBURegisterOperatorModule.Header</code>.
/// since:
/// 3.28.0
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) SWIFT_METATYPE(SBUBarButtonItem) _Nonnull LeftBarButton;)
+ (SWIFT_METATYPE(SBUBarButtonItem) _Nonnull)LeftBarButton SWIFT_WARN_UNUSED_RESULT;
+ (void)setLeftBarButton:(SWIFT_METATYPE(SBUBarButtonItem) _Nonnull)value;
/// Represents the metatype of title view in <code>SBURegisterOperatorModule.Header</code>.
/// since:
/// 3.28.0
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) SWIFT_METATYPE(SBUNavigationTitleView) _Nonnull TitleView;)
+ (SWIFT_METATYPE(SBUNavigationTitleView) _Nonnull)TitleView SWIFT_WARN_UNUSED_RESULT;
+ (void)setTitleView:(SWIFT_METATYPE(SBUNavigationTitleView) _Nonnull)value;
/// Represents the metatype of right bar button in <code>SBURegisterOperatorModule.Header</code>.
/// since:
/// 3.28.0
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) SWIFT_METATYPE(SBUBarButtonItem) _Nonnull RightBarButton;)
+ (SWIFT_METATYPE(SBUBarButtonItem) _Nonnull)RightBarButton SWIFT_WARN_UNUSED_RESULT;
...
@interface Header (SWIFT_EXTENSION(SendbirdUIKit))
/// Represents the metatype of left bar button in <code>SBUMessageSearchModule.Header</code>.
/// since:
/// 3.28.0
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) SWIFT_METATYPE(SBUBarButtonItem) _Nullable LeftBarButton;)
+ (SWIFT_METATYPE(SBUBarButtonItem) _Nullable)LeftBarButton SWIFT_WARN_UNUSED_RESULT;
+ (void)setLeftBarButton:(SWIFT_METATYPE(SBUBarButtonItem) _Nullable)value;
/// Represents the metatype of title view in <code>SBUMessageSearchModule.Header</code>.
/// since:
/// 3.28.0
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) SWIFT_METATYPE(SBUSearchBar) _Nonnull TitleView;)
+ (SWIFT_METATYPE(SBUSearchBar) _Nonnull)TitleView SWIFT_WARN_UNUSED_RESULT;
+ (void)setTitleView:(SWIFT_METATYPE(SBUSearchBar) _Nonnull)value;
/// Represents the metatype of right bar button in <code>SBUMessageSearchModule.Header</code>.
/// since:
/// 3.28.0
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) SWIFT_METATYPE(SBUBarButtonItem) _Nonnull RightBarButton;)
+ (SWIFT_METATYPE(SBUBarButtonItem) _Nonnull)RightBarButton SWIFT_WARN_UNUSED_RESULT;
...
/// Collection view cell that conforms to <code>SBUViewLifeCycle</code>.
/// since:
/// 3.10.0
...
/// This is a horizontal suggested reply view cell for displaying a value of <code>options</code>.
/// since:
/// 3.23.0
SWIFT_CLASS("_TtC13SendbirdUIKit32HorizontalSuggestedReplyViewCell")
@interface HorizontalSuggestedReplyViewCell : SBUCollectionViewCell
- (void)setupViews;
- (void)setupStyles;
- (void)setupLayouts;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
...
/// The <code>SBUBaseChannelModule</code>’s component class that represents input
SWIFT_CLASS("_TtCC13SendbirdUIKit20SBUBaseChannelModule5Input")
@interface Input : UIView
/// <code>inputVStackView</code> is a vertical stackview to make it easier to add new views at the same level as <code>messageInputView</code>.
/// note:
/// It’s not recommended that modify the properties of inputVStackView’s axis, alignment, etc.
/// important:
/// It does <em>NOT</em> guarantee that the layout of <code>messageInputView</code> will look correct.
@property (nonatomic, strong) SBUStackView * _Nonnull inputVStackView;
/// The <code>messageInputView</code> displays an input field where users can send or edit a message.
/// The default view type is <code>SBUMessageInputView</code>.
/// note:
/// If this value is updated, an event delegate for <code>messageInputView</code> will be internally set as <code>self</code>. <em>However</em>, if you wish to use a custom object that does <em>NOT</em> override <code>SBUMessageInputView</code>, you need to manually set an event delegate.
@property (nonatomic, strong) UIView * _Nullable messageInputView;
/// (Read only) The channel object.
/// note:
/// See <code>baseChannelModule(_:channelForInputView:)</code>, a data source function.
@property (nonatomic, readonly, strong) SBDBaseChannel * _Nullable baseChannel;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER SWIFT_UNAVAILABLE_MSG("'init' has been renamed to 'SBUBaseChannelModule.Input()'");
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER SWIFT_UNAVAILABLE_MSG("'init' has been renamed to 'SBUBaseChannelModule.Input()'");
/// Set values of the views in the input component when it needs.
- (void)setupViews;
/// Sets layouts of the views in the input component.
- (void)setupLayouts;
/// Updates mode of <code>messageInputView</code>.
/// \param mode <code>SBUMessageInputMode</code> value.
///
/// \param message <code>BaseMessage</code> value for some specific modes such as <code>.edit</code> or <code>.quoteReply</code>
///
- (void)updateMessageInputMode:(enum SBUMessageInputMode)mode message:(SBDBaseMessage * _Nullable)message;
/// Updates state of <code>messageInputView</code>.
/// important:
/// The implemetation is required. Please refer to same method in  <code>SBUGroupChannelModule.Input</code>
- (void)updateMessageInputModeState;
/// Updates frozen mode of <code>messageInputView</code>.
/// important:
/// The implemetation is required. Please refer to same method in  <code>SBUGroupChannelModule.Input</code>
- (void)updateFrozenModeState;
/// Call this function when an image file has been picked from <code>UIImagePickerController</code>. This function will invoke corresponding delegate method such as <code>SBUGroupChannelModuleInputDelegate groupChannelModule(_:didPickFileData:fileName:mimeType:parentMessage:)</code>
/// \param info Image information selected in <code>UIImagePickerController</code>
///
- (void)pickImageFileWithInfo:(NSDictionary<UIImagePickerControllerInfoKey, id> * _Nonnull)info;
/// Call this function when a video file has been picked from <code>UIImagePickerController</code>. This function will invoke corresponding delegate method such as <code>SBUGroupChannelModuleInputDelegate groupChannelModule(_:didPickFileData:fileName:mimeType:parentMessage:)</code>
/// \param info Video information selected in <code>UIImagePickerController</code>
///
- (void)pickVideoFileWithInfo:(NSDictionary<UIImagePickerControllerInfoKey, id> * _Nonnull)info;
/// Call this function when a picked <code>itemProvider</code> of <code>PHPickerResult</code> has <code>UTType.image</code> identifier.
/// This function will invoke corresponding delegate method such as <code>SBUGroupChannelModuleInputDelegate groupChannelModule(_:didPickFileData:fileName:mimeType:parentMessage:)</code>
/// \param itemProvider <code>NSItemProvider</code> object from <code>PHPickerResult</code>.
///
- (void)pickImageFileWithItemProvider:(NSItemProvider * _Nonnull)itemProvider SWIFT_AVAILABILITY(ios,introduced=14.0);
/// Call this function when a picked <code>itemProvider</code> of <code>PHPickerResult</code> has <code>UTType.gif</code> identifier.
/// This function will invoke corresponding delegate method such as <code>SBUGroupChannelModuleInputDelegate groupChannelModule(_:didPickFileData:fileName:mimeType:parentMessage:)</code>
/// \param itemProvider <code>NSItemProvider</code> object from <code>PHPickerResult</code>.
///
- (void)pickGIFFileWithItemProvider:(NSItemProvider * _Nonnull)itemProvider SWIFT_AVAILABILITY(ios,introduced=14.0);
/// Call this function when a picked <code>itemProvider</code> of <code>PHPickerResult</code> has <code>UTType.video</code> identifier.
/// This function will invoke corresponding delegate method such as <code>SBUGroupChannelModuleInputDelegate groupChannelModule(_:didPickFileData:fileName:mimeType:parentMessage:)</code>
/// \param itemProvider <code>NSItemProvider</code> object from <code>PHPickerResult</code>.
///
- (void)pickVideoFileWithItemProvider:(NSItemProvider * _Nonnull)itemProvider SWIFT_AVAILABILITY(ios,introduced=14.0);
...
///
- (void)pickImageData:(NSData * _Nonnull)data fileName:(NSString * _Nullable)fileName mimeType:(NSString * _Nullable)mimeType;
/// Called when the video is picked from <code>SBUSelectablePhotoViewController</code>
/// This function will invoke corresponding delegate method such as <code>SBUGroupChannelModuleInputDelegate groupChannelModule(_:didPickFileData:fileName:mimeType:parentMessage:)</code>
/// \param url The URL of the video
///
- (void)pickVideoURL:(NSURL * _Nonnull)url;
/// Call this function when a video file has been picked from <code>UIDocumentPickerViewController</code>. This function will invoke corresponding delegate method such as <code>SBUGroupChannelModuleInputDelegate groupChannelModule(_:didPickFileData:fileName:mimeType:parentMessage:)</code>
/// \param documentURLs Document information selected in <code>UIDocumentPickerViewController</code>
///
- (void)pickDocumentFileWithDocumentURLs:(NSArray<NSURL *> * _Nonnull)documentURLs;
- (void)messageInputViewDidStartTyping;
- (void)messageInputViewDidEndTyping;
- (void)messageInputViewDidSelectAdd:(SBUMessageInputView * _Nonnull)messageInputView;
...
- (BOOL)messageInputView:(SBUMessageInputView * _Nonnull)messageInputView shouldChangeTextIn:(NSRange)range replacementText:(NSString * _Nonnull)text SWIFT_WARN_UNUSED_RESULT;
- (BOOL)messageInputView:(SBUMessageInputView * _Nonnull)messageInputView shouldInteractWith:(NSURL * _Nonnull)url in:(NSRange)characterRange interaction:(UITextItemInteraction)interaction SWIFT_WARN_UNUSED_RESULT;
- (void)messageInputView:(SBUMessageInputView * _Nonnull)messageInputView didChangeSelection:(NSRange)range;
- (void)messageInputViewDidTapVoiceMessage:(SBUMessageInputView * _Nonnull)messageInputView;
- (SBDBaseChannel * _Nullable)channelForMessageInputView:(SBUMessageInputView * _Nonnull)messageInputView SWIFT_WARN_UNUSED_RESULT;
@end

@class SBDOpenChannel;

/// The <code>SBUOpenChannelModule</code>’s component class that represents input.
SWIFT_CLASS("_TtCC13SendbirdUIKit20SBUOpenChannelModule5Input")
@interface Input : Input
/// The open channel object casted from <code>baseChannel</code>.
@property (nonatomic, readonly, strong) SBDOpenChannel * _Nullable channel;
- (void)setupViews;
/// Updates styles with overlaying state.
/// \param overlaid The boolean value whether the input component is overlaid or not. The default value is <code>false</code>.
///
- (void)updateStylesWithOverlaid:(BOOL)overlaid;
- (void)pickImageFileWithInfo:(NSDictionary<UIImagePickerControllerInfoKey, id> * _Nonnull)info;
- (void)pickVideoFileWithInfo:(NSDictionary<UIImagePickerControllerInfoKey, id> * _Nonnull)info;
...
/// Updates state of <code>messageInputView</code>.
- (void)updateMessageInputModeState;
/// This is used to update frozen mode of <code>messageInputView</code>. This will call <code>SBUBaseChannelModuleInputDelegate baseChannelModule(_:didUpdateFrozenState:)</code>
- (void)updateFrozenModeState;
/// Updates the mode of <code>messageInputView</code> according to frozen and muted state of the channel.
- (void)updateMutedModeState;
@end


@interface Input (SWIFT_EXTENSION(SendbirdUIKit))
/// The component property that the message input view.
/// since:
/// 3.28.0
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) SWIFT_METATYPE(SBUMessageInputView) _Nonnull MessageInputView;)
+ (SWIFT_METATYPE(SBUMessageInputView) _Nonnull)MessageInputView SWIFT_WARN_UNUSED_RESULT;
+ (void)setMessageInputView:(SWIFT_METATYPE(SBUMessageInputView) _Nonnull)value;
@end

@class SBUSuggestedMentionList;
...
@interface SBUMessageThreadModuleInput : Input
@property (nonatomic, strong) SBUSuggestedMentionList * _Nullable suggestedMentionList;
/// The group channel object casted from <code>baseChannel</code>.
...
@property (nonatomic, strong) SBUMentionManager * _Nullable mentionManager;
- (void)setupViews;
- (void)setupLayouts;
- (void)pickImageFileWithInfo:(NSDictionary<UIImagePickerControllerInfoKey, id> * _Nonnull)info;
- (void)pickVideoFileWithInfo:(NSDictionary<UIImagePickerControllerInfoKey, id> * _Nonnull)info;
...
/// \param itemProviders An array of NSItemProvider
///
- (void)pickMultipleImageFilesWithItemProviders:(NSArray<NSItemProvider *> * _Nonnull)itemProviders SWIFT_AVAILABILITY(ios,introduced=14.0);
- (void)updateMessageInputMode:(enum SBUMessageInputMode)mode message:(SBDBaseMessage * _Nullable)message;
/// Updates state of <code>messageInputView</code>.
- (void)updateMessageInputModeState;
/// This is used to update frozen mode of <code>messageInputView</code>. This will call <code>SBUBaseChannelModuleInputDelegate baseChannelModule(_:didUpdateFrozenState:)</code>
- (void)updateFrozenModeState;
/// Updates the mode of <code>messageInputView</code> according to broadcast state of the channel.
- (void)updateBroadcastModeState;
/// Updates the mode of <code>messageInputView</code> according to frozen and muted state of the channel.
- (void)updateMutedModeState;
/// Updates the placeholder text.
- (void)updatePlaceholder;
/// Initializes <code>SBUMentionManager</code> instance and configure with attributes.
/// The <code>messageInputView</code> updates to use its <code>defaultAttributes</code> and <code>mentionedAttributes</code>.
- (void)setupMentionManager;
/// Handles pending mention suggestion. This calls when the channel view model receives member list from callback.
- (void)handlePendingMentionSuggestionWith:(NSArray<SBUUser *> * _Nullable)members;
/// Updates <code>suggestedMentionList</code> with <code>members</code>
- (void)updateSuggestedMentionListWith:(NSArray<SBUUser *> * _Nonnull)members;
/// Presents <code>suggestedMentionList</code>
- (void)presentSuggestedMentionList;
/// Dismiss <code>suggestedMentionList</code> and remove from super view.
- (void)dismissSuggestedMentionList;
...
/// note:
/// If there’s mentions in <code>mentionManager.mentionedList</code>, It invokes <code>messageInputView(_:didSelectSend:mentionManager:)</code> instead.
...
/// note:
/// If there’s mentions in <code>mentionManager.mentionedList</code>, It invokes <code>messageInputView(_:willChangeMode:message:mentionManager:)</code> instead.
/// \param messageInputView <code>SBUMessageinputView</code> object.
///
/// \param mode <code>SBUMessageInputMode</code> value. The <code>messageInputView</code> changes its mode to this value.
///
/// \param message <code>BaseMessage</code> object. It’s <code>nil</code> when the <code>mode</code> is <code>none</code>.
///
- (void)messageInputView:(SBUMessageInputView * _Nonnull)messageInputView willChangeMode:(enum SBUMessageInputMode)mode message:(SBDBaseMessage * _Nullable)message;
/// Called when the message input mode will be changed via <code>setMode(_:message:)</code> method and need to reset the <code>mentionManager</code>.
- (void)messageInputView:(SBUMessageInputView * _Nonnull)messageInputView willChangeMode:(enum SBUMessageInputMode)mode message:(SBDBaseMessage * _Nullable)message mentionManager:(SBUMentionManager * _Nonnull)mentionManager;
- (void)messageInputView:(SBUMessageInputView * _Nonnull)messageInputView didSelectSend:(NSAttributedString * _Nonnull)text mentionManager:(SBUMentionManager * _Nonnull)mentionManager parentMessage:(SBDBaseMessage * _Nullable)parentMessage;
- (void)messageInputView:(SBUMessageInputView * _Nonnull)messageInputView didSelectEdit:(NSString * _Nonnull)text;
- (void)messageInputView:(SBUMessageInputView * _Nonnull)messageInputView didSelectEdit:(NSAttributedString * _Nonnull)text mentionManager:(SBUMentionManager * _Nonnull)mentionManager;
- (void)messageInputViewDidTapVoiceMessage:(SBUMessageInputView * _Nonnull)messageInputView;
- (void)mentionManager:(SBUMentionManager * _Nonnull)manager didChangeSuggestedMention:(NSArray<SBUUser *> * _Nonnull)members filteredText:(NSString * _Nullable)filteredText isTriggered:(BOOL)isTriggered;
- (void)mentionManager:(SBUMentionManager * _Nonnull)manager didInsertMentionsTo:(UITextView * _Nonnull)textView;
- (void)mentionManager:(SBUMentionManager * _Nonnull)manager shouldLoadSuggestedMentions:(NSString * _Nonnull)keyword;
- (void)suggestedUserList:(SBUSuggestedMentionList * _Nonnull)list didSelectUser:(SBUUser * _Nonnull)user;
@end

@class SBUVoiceMessageInputView;

@interface SBUMessageThreadModuleInput (SWIFT_EXTENSION(SendbirdUIKit))
/// The component property that the message input view.
/// since:
/// 3.28.0
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) SWIFT_METATYPE(SBUMessageInputView) _Nonnull MessageInputView;)
...
/// since:
/// 3.28.0
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) SWIFT_METATYPE(SBUVoiceMessageInputView) _Nonnull VoiceMessageInputView;)
+ (SWIFT_METATYPE(SBUVoiceMessageInputView) _Nonnull)VoiceMessageInputView SWIFT_WARN_UNUSED_RESULT;
+ (void)setVoiceMessageInputView:(SWIFT_METATYPE(SBUVoiceMessageInputView) _Nonnull)value;
@end


/// The <code>SBUGroupChannelModule</code>’s component class that represents input
SWIFT_CLASS_NAMED("Input")
@interface SBUGroupChannelModuleInput : Input
@property (nonatomic, strong) SBUSuggestedMentionList * _Nullable suggestedMentionList;
/// A current quoted message in message input view. This value is only available when the <code>messageInputView</code> is type of <code>SBUMessageInputView</code> that supports the message replying feature.
@property (nonatomic, readonly, strong) SBDBaseMessage * _Nullable currentQuotedMessage;
/// The group channel object casted from <code>baseChannel</code>.
@property (nonatomic, readonly, strong) SBDGroupChannel * _Nullable channel;
@property (nonatomic, strong) SBUMentionManager * _Nullable mentionManager;
- (void)setupViews;
...
/// Updates the mode of <code>messageInputView</code> according to frozen and muted state of the channel.
- (void)updateMutedModeState;
/// Updates the mode of <code>messageInputView</code> according to notification state of the channel.
/// since:
/// 3.5.0
- (void)updateNotificationModeState;
/// Initializes <code>SBUMentionManager</code> instance and configure with attributes.
/// The <code>messageInputView</code> updates to use its <code>defaultAttributes</code> and <code>mentionedAttributes</code>.
- (void)setupMentionManager;
/// Handles pending mention suggestion. This calls when the channel view model receives member list from callback.
...
/// Called when the message input mode will be changed via <code>setMode(_:message:)</code> method and need to reset the <code>mentionManager</code>.
- (void)messageInputView:(SBUMessageInputView * _Nonnull)messageInputView willChangeMode:(enum SBUMessageInputMode)mode message:(SBDBaseMessage * _Nullable)message mentionManager:(SBUMentionManager * _Nonnull)mentionManager;
- (void)messageInputView:(SBUMessageInputView * _Nonnull)messageInputView didSelectSend:(NSAttributedString * _Nonnull)text mentionManager:(SBUMentionManager * _Nonnull)mentionManager;
- (void)messageInputView:(SBUMessageInputView * _Nonnull)messageInputView didSelectEdit:(NSString * _Nonnull)text;
- (void)messageInputView:(SBUMessageInputView * _Nonnull)messageInputView didSelectEdit:(NSAttributedString * _Nonnull)text mentionManager:(SBUMentionManager * _Nonnull)mentionManager;
- (void)messageInputViewDidTapVoiceMessage:(SBUMessageInputView * _Nonnull)messageInputView;
- (void)mentionManager:(SBUMentionManager * _Nonnull)manager didChangeSuggestedMention:(NSArray<SBUUser *> * _Nonnull)members filteredText:(NSString * _Nullable)filteredText isTriggered:(BOOL)isTriggered;
...
@interface SBUGroupChannelModuleInput (SWIFT_EXTENSION(SendbirdUIKit))
/// The component property that the message input view.
/// since:
/// 3.28.0
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) SWIFT_METATYPE(SBUMessageInputView) _Nonnull MessageInputView;)
...
/// The message cell for <code>MultipleFilesMessage</code> object.
/// Use <code>register(multipleFilesMessageCell:nib:)</code> to update.
/// since:
/// 3.10.0
@property (nonatomic, readonly, strong) SBUBaseMessageCell * _Nullable multipleFilesMessageCell;
/// The message cell for <code>SBUTypingIndicatorMessage</code> object.
/// Use <code>register(typingIndicatorMessageCell:nib:)</code> to update.
/// since:
/// 3.12.0
@property (nonatomic, readonly, strong) SBUBaseMessageCell * _Nullable typingIndicatorMessageCell;
/// The message cell for <code>MessageTemplate</code> data in <code>extendedMessagePayload</code>.
/// Use <code>register(messageTemplateCell:nib:)</code> to update.
/// since:
/// 3.27.2
...
/// Registers a custom cell as a multiple files message cell based on <code>SBUBaseMessageCell</code>.
/// important:
/// To register custom message cell, please use this function before calling <code>configure(delegate:dataSource:theme:)</code>
/// \code
...
/// Registers a custom cell as a typing message cell based on <code>SBUBaseMessageCell</code>.
/// important:
/// To register custom message cell, please use this function before calling <code>configure(delegate:dataSource:theme:)</code>
/// \code
...
/// \endcodesince:
/// 3.12.0
/// \param typingIndicatorMessageCell Customized typing indicator message cell
///
/// \param nib nib information. If the value is nil, the nib file is not used.
///
...
/// Registers a custom cell as a message template cell based on <code>SBUMessageTemplateCell</code>.
/// important:
/// To register custom message cell, please use this function before calling <code>configure(delegate:dataSource:theme:)</code>
/// \code
...
@class SBUModerationCell;

@interface SBUModerationsModuleList (SWIFT_EXTENSION(SendbirdUIKit))
/// Represents the metatype of moderation cell in moderation module.
/// since:
/// 3.28.0
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) SWIFT_METATYPE(SBUModerationCell) _Nonnull ModerationCell;)
+ (SWIFT_METATYPE(SBUModerationCell) _Nonnull)ModerationCell SWIFT_WARN_UNUSED_RESULT;
+ (void)setModerationCell:(SWIFT_METATYPE(SBUModerationCell) _Nonnull)value;
@end
...
- (void)setupItems;
- (void)configureCell:(UITableViewCell * _Nullable)cell indexPath:(NSIndexPath * _Nonnull)indexPath;
@property (nonatomic, strong) UIView * _Nullable headerWrapper;
- (void)reloadTableView;
@end
...
@class SBUChannelSettingsChannelInfoView;
@class SBUOpenChannelSettingCell;

@interface SBUOpenChannelSettingsModuleList (SWIFT_EXTENSION(SendbirdUIKit))
/// Represents the type of channel info view on the open channel settings module.
/// since:
/// 3.28.0
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) SWIFT_METATYPE(SBUChannelSettingsChannelInfoView) _Nonnull ChannelInfoView;)
+ (SWIFT_METATYPE(SBUChannelSettingsChannelInfoView) _Nonnull)ChannelInfoView SWIFT_WARN_UNUSED_RESULT;
+ (void)setChannelInfoView:(SWIFT_METATYPE(SBUChannelSettingsChannelInfoView) _Nonnull)value;
/// Represents the type of setting cell on the open channel settings module.
/// since:
/// 3.28.0
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) SWIFT_METATYPE(SBUOpenChannelSettingCell) _Nonnull SettingCell;)
+ (SWIFT_METATYPE(SBUOpenChannelSettingCell) _Nonnull)SettingCell SWIFT_WARN_UNUSED_RESULT;
+ (void)setSettingCell:(SWIFT_METATYPE(SBUOpenChannelSettingCell) _Nonnull)value;
@end
...
/// since:
/// 3.28.0
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) SWIFT_METATYPE(SBUEmptyView) _Nonnull EmptyView;)
+ (SWIFT_METATYPE(SBUEmptyView) _Nonnull)EmptyView SWIFT_WARN_UNUSED_RESULT;
+ (void)setEmptyView:(SWIFT_METATYPE(SBUEmptyView) _Nonnull)value;
/// Represents the type of channel cell on the open channel list module.
/// since:
/// 3.28.0
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) SWIFT_METATYPE(SBUBaseChannelCell) _Nonnull ChannelCell;)
+ (SWIFT_METATYPE(SBUBaseChannelCell) _Nonnull)ChannelCell SWIFT_WARN_UNUSED_RESULT;
+ (void)setChannelCell:(SWIFT_METATYPE(SBUBaseChannelCell) _Nonnull)value;
@end

@class SBUGroupChannelSettingCell;
...
/// since:
/// 3.28.0
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) SWIFT_METATYPE(SBUGroupChannelSettingCell) _Nonnull SettingCell;)
+ (SWIFT_METATYPE(SBUGroupChannelSettingCell) _Nonnull)SettingCell SWIFT_WARN_UNUSED_RESULT;
+ (void)setSettingCell:(SWIFT_METATYPE(SBUGroupChannelSettingCell) _Nonnull)value;
@end
...
/// since:
/// 3.28.0
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) SWIFT_METATYPE(SBUUserCell) _Nonnull UserCell;)
+ (SWIFT_METATYPE(SBUUserCell) _Nonnull)UserCell SWIFT_WARN_UNUSED_RESULT;
+ (void)setUserCell:(SWIFT_METATYPE(SBUUserCell) _Nonnull)value;
@end
...
/// since:
/// 3.28.0
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) SWIFT_METATYPE(SBUMessageSearchResultCell) _Nonnull MessageSearchResultCell;)
+ (SWIFT_METATYPE(SBUMessageSearchResultCell) _Nonnull)MessageSearchResultCell SWIFT_WARN_UNUSED_RESULT;
+ (void)setMessageSearchResultCell:(SWIFT_METATYPE(SBUMessageSearchResultCell) _Nonnull)value;
@end
...
/// The message cell for <code>FileMessage</code> object. Use <code>register(fileMessageCell:nib:)</code> to update.
@property (nonatomic, readonly, strong) SBUBaseMessageCell * _Nullable fileMessageCell;
/// The message cell for <code>MultipleFilesMessage</code> object. Use <code>register(multipleFilesMessageCell:nib:)</code> to update.
/// since:
/// 3.10.0
@property (nonatomic, readonly, strong) SBUBaseMessageCell * _Nullable multipleFilesMessageCell;
/// The message cell for some unknown message which is not a type of <code>AdminMessage</code> | <code>UserMessage</code> | <code> FileMessage</code>. Use <code>register(unknownMessageCell:nib:)</code> to update.
...
/// since:
/// 3.15.0
/// \param cell <code>SBUBaseMessageCell</code>.
///
- (void)reloadCell:(SBUBaseMessageCell * _Nullable)cell;
@end

@class SBUOpenChannelBaseMessageCell;

/// A module component that represent the list of <code>SBUOpenChannelModule</code>.
SWIFT_CLASS_NAMED("List")
@interface SBUOpenChannelModuleList : SBUBaseChannelModuleList
/// The message cell for <code>AdminMessage</code> object. Use <code>register(adminMessageCell:nib:)</code> to update.
@property (nonatomic, strong) SBUOpenChannelBaseMessageCell * _Nullable adminMessageCell;
/// The message cell for <code>UserMessage</code> object. Use <code>register(userMessageCell:nib:)</code> to update.
@property (nonatomic, strong) SBUOpenChannelBaseMessageCell * _Nullable userMessageCell;
/// The message cell for <code>FileMessage</code> object. Use <code>register(fileMessageCell:nib:)</code> to update.
@property (nonatomic, strong) SBUOpenChannelBaseMessageCell * _Nullable fileMessageCell;
/// The message cell for some unknown message which is not a type of <code>AdminMessage</code> | <code>UserMessage</code> | <code> FileMessage</code>. Use <code>register(unknownMessageCell:nib:)</code> to update.
@property (nonatomic, strong) SBUOpenChannelBaseMessageCell * _Nullable unknownMessageCell;
/// The custom message cell for some <code>BaseMessage</code>. Use <code>register(customMessageCell:nib:)</code> to update.
@property (nonatomic, strong) SBUOpenChannelBaseMessageCell * _Nullable customMessageCell;
/// The current <em>open</em> channel object casted from <code>baseChannel</code>
@property (nonatomic, readonly, strong) SBDOpenChannel * _Nullable channel;
/// The boolean value that indicates overlaying state of the list component. The value is returned by <code>openChannelModuleIsOverlaid(_:)</code>
@property (nonatomic, readonly) BOOL isOverlaid;
- (void)setupViews;
- (void)setupLayouts;
...
- (void)scrollViewDidScroll:(UIScrollView * _Nonnull)scrollView;
- (void)reloadTableViewWithNeedsToLayout:(BOOL)needsToLayout;
/// Registers a custom cell as a admin message cell based on <code>SBUOpenChannelBaseMessageCell</code>.
/// \param adminMessageCell Customized admin message cell
///
/// \param nib nib information. If the value is nil, the nib file is not used.
///
- (void)registerWithAdminMessageCell:(SBUOpenChannelBaseMessageCell * _Nonnull)adminMessageCell nib:(UINib * _Nullable)nib;
/// Registers a custom cell as a user message cell based on <code>SBUOpenChannelBaseMessageCell</code>.
/// \param userMessageCell Customized user message cell
///
/// \param nib nib information. If the value is nil, the nib file is not used.
///
- (void)registerWithUserMessageCell:(SBUOpenChannelBaseMessageCell * _Nonnull)userMessageCell nib:(UINib * _Nullable)nib;
/// Registers a custom cell as a file message cell based on <code>SBUOpenChannelBaseMessageCell</code>.
/// \param fileMessageCell Customized file message cell
///
/// \param nib nib information. If the value is nil, the nib file is not used.
///
- (void)registerWithFileMessageCell:(SBUOpenChannelBaseMessageCell * _Nonnull)fileMessageCell nib:(UINib * _Nullable)nib;
/// Registers a custom cell as a unknown message cell based on <code>SBUOpenChannelBaseMessageCell</code>.
/// \param unknownMessageCell Customized unknown message cell
///
/// \param nib nib information. If the value is nil, the nib file is not used.
///
- (void)registerWithUnknownMessageCell:(SBUOpenChannelBaseMessageCell * _Nonnull)unknownMessageCell nib:(UINib * _Nullable)nib;
/// Registers a custom cell as a additional message cell based on <code>SBUOpenChannelBaseMessageCell</code>.
/// \param customMessageCell Customized message cell
///
/// \param nib nib information. If the value is nil, the nib file is not used.
///
- (void)registerWithCustomMessageCell:(SBUOpenChannelBaseMessageCell * _Nonnull)customMessageCell nib:(UINib * _Nullable)nib;
- (CGPoint)calculatorMenuPointWithIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT SWIFT_DEPRECATED_MSG("", "calculateMessageMenuCGPointWithIndexPath:");
/// Calculates the <code>CGPoint</code> value that indicates where to draw the message menu in the open channel screen.
/// \param indexPath The index path of the selected message cell
///
///
/// returns:
/// <code>CGPoint</code> value
- (CGPoint)calculateMessageMenuCGPointWithIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
- (void)showMessageContextMenuFor:(SBDBaseMessage * _Nonnull)message cell:(UITableViewCell * _Nonnull)cell forRowAt:(NSIndexPath * _Nonnull)indexPath;
/// Sets gestures in message cell.
/// \param cell The message cell
///
...
/// \param indexPath Cell’s indexPath
///
- (void)setMessageCellGestures:(SBUOpenChannelBaseMessageCell * _Nonnull)cell message:(SBDBaseMessage * _Nonnull)message indexPath:(NSIndexPath * _Nonnull)indexPath;
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
/// Configures cell with message for a particular row.
/// \param messageCell <code>SBUOpenChannelBaseMessageCell</code> object.
///
/// \param message The message for <code>messageCell</code>.
///
/// \param indexPath An index path representing the <code>messageCell</code>
///
- (void)configureCell:(SBUOpenChannelBaseMessageCell * _Nonnull)messageCell message:(SBDBaseMessage * _Nonnull)message forRowAt:(NSIndexPath * _Nonnull)indexPath;
/// Register the message cell to the table view.
- (void)registerWithMessageCell:(SBUOpenChannelBaseMessageCell * _Nonnull)messageCell nib:(UINib * _Nullable)nib;
/// Generates identifier of message cell.
/// \param message Message object
///
///
...
@class SBUChannelStateBanner;
@class SBUScrollBottomView;
@class SBUUserProfileView;

@interface SBUOpenChannelModuleList (SWIFT_EXTENSION(SendbirdUIKit))
...
/// since:
/// 3.28.0
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) SWIFT_METATYPE(SBUOpenChannelBaseMessageCell) _Nonnull AdminMessageCell;)
+ (SWIFT_METATYPE(SBUOpenChannelBaseMessageCell) _Nonnull)AdminMessageCell SWIFT_WARN_UNUSED_RESULT;
+ (void)setAdminMessageCell:(SWIFT_METATYPE(SBUOpenChannelBaseMessageCell) _Nonnull)value;
/// Represents the type of user message cell on the open channel module.
/// since:
/// 3.28.0
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) SWIFT_METATYPE(SBUOpenChannelBaseMessageCell) _Nonnull UserMessageCell;)
+ (SWIFT_METATYPE(SBUOpenChannelBaseMessageCell) _Nonnull)UserMessageCell SWIFT_WARN_UNUSED_RESULT;
+ (void)setUserMessageCell:(SWIFT_METATYPE(SBUOpenChannelBaseMessageCell) _Nonnull)value;
/// Represents the type of file message cell on the open channel module.
/// since:
/// 3.28.0
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) SWIFT_METATYPE(SBUOpenChannelBaseMessageCell) _Nonnull FileMessageCell;)
+ (SWIFT_METATYPE(SBUOpenChannelBaseMessageCell) _Nonnull)FileMessageCell SWIFT_WARN_UNUSED_RESULT;
+ (void)setFileMessageCell:(SWIFT_METATYPE(SBUOpenChannelBaseMessageCell) _Nonnull)value;
/// Represents the type of unknown message cell on the open channel module.
/// since:
/// 3.28.0
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) SWIFT_METATYPE(SBUOpenChannelBaseMessageCell) _Nonnull UnknownMessageCell;)
+ (SWIFT_METATYPE(SBUOpenChannelBaseMessageCell) _Nonnull)UnknownMessageCell SWIFT_WARN_UNUSED_RESULT;
+ (void)setUnknownMessageCell:(SWIFT_METATYPE(SBUOpenChannelBaseMessageCell) _Nonnull)value;
/// Represents the type of custom message cell on the open channel module.
/// since:
/// 3.28.0
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) SWIFT_METATYPE(SBUOpenChannelBaseMessageCell) _Nullable CustomMessageCell;)
+ (SWIFT_METATYPE(SBUOpenChannelBaseMessageCell) _Nullable)CustomMessageCell SWIFT_WARN_UNUSED_RESULT;
+ (void)setCustomMessageCell:(SWIFT_METATYPE(SBUOpenChannelBaseMessageCell) _Nullable)value;
/// Represents the type of channel state banner on the open channel module.
/// since:
/// 3.28.0
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) SWIFT_METATYPE(SBUChannelStateBanner) _Nonnull ChannelStateBanner;)
+ (SWIFT_METATYPE(SBUChannelStateBanner) _Nonnull)ChannelStateBanner SWIFT_WARN_UNUSED_RESULT;
+ (void)setChannelStateBanner:(SWIFT_METATYPE(SBUChannelStateBanner) _Nonnull)value;
/// Represents the type of scroll bottom view on the open channel module.
/// since:
/// 3.28.0
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) SWIFT_METATYPE(SBUScrollBottomView) _Nonnull ScrollBottomView;)
+ (SWIFT_METATYPE(SBUScrollBottomView) _Nonnull)ScrollBottomView SWIFT_WARN_UNUSED_RESULT;
+ (void)setScrollBottomView:(SWIFT_METATYPE(SBUScrollBottomView) _Nonnull)value;
/// Represents the type of user profile view on the open channel module.
/// since:
/// 3.28.0
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) SWIFT_METATYPE(SBUUserProfileView) _Nonnull UserProfileView;)
+ (SWIFT_METATYPE(SBUUserProfileView) _Nonnull)UserProfileView SWIFT_WARN_UNUSED_RESULT;
+ (void)setUserProfileView:(SWIFT_METATYPE(SBUUserProfileView) _Nonnull)value;
@end
...
/// since:
/// 3.28.0
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) SWIFT_METATYPE(SBUBaseMessageCell) _Nonnull AdminMessageCell;)
+ (SWIFT_METATYPE(SBUBaseMessageCell) _Nonnull)AdminMessageCell SWIFT_WARN_UNUSED_RESULT;
+ (void)setAdminMessageCell:(SWIFT_METATYPE(SBUBaseMessageCell) _Nonnull)value;
/// Represents the type of user message cell on the message thread module.
/// since:
/// 3.28.0
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) SWIFT_METATYPE(SBUBaseMessageCell) _Nonnull UserMessageCell;)
+ (SWIFT_METATYPE(SBUBaseMessageCell) _Nonnull)UserMessageCell SWIFT_WARN_UNUSED_RESULT;
+ (void)setUserMessageCell:(SWIFT_METATYPE(SBUBaseMessageCell) _Nonnull)value;
/// Represents the type of file message cell on the message thread module.
/// since:
/// 3.28.0
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) SWIFT_METATYPE(SBUBaseMessageCell) _Nonnull FileMessageCell;)
+ (SWIFT_METATYPE(SBUBaseMessageCell) _Nonnull)FileMessageCell SWIFT_WARN_UNUSED_RESULT;
+ (void)setFileMessageCell:(SWIFT_METATYPE(SBUBaseMessageCell) _Nonnull)value;
/// Represents the type of multiple files message cell on the message thread module.
/// since:
/// 3.28.0
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) SWIFT_METATYPE(SBUBaseMessageCell) _Nonnull MultipleFilesMessageCell;)
+ (SWIFT_METATYPE(SBUBaseMessageCell) _Nonnull)MultipleFilesMessageCell SWIFT_WARN_UNUSED_RESULT;
+ (void)setMultipleFilesMessageCell:(SWIFT_METATYPE(SBUBaseMessageCell) _Nonnull)value;
/// Represents the type of unknown message cell on the message thread module.
/// since:
/// 3.28.0
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) SWIFT_METATYPE(SBUBaseMessageCell) _Nonnull UnknownMessageCell;)
+ (SWIFT_METATYPE(SBUBaseMessageCell) _Nonnull)UnknownMessageCell SWIFT_WARN_UNUSED_RESULT;
+ (void)setUnknownMessageCell:(SWIFT_METATYPE(SBUBaseMessageCell) _Nonnull)value;
/// Represents the type of custom message cell on the message thread module.
/// since:
/// 3.28.0
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) SWIFT_METATYPE(SBUBaseMessageCell) _Nullable CustomMessageCell;)
+ (SWIFT_METATYPE(SBUBaseMessageCell) _Nullable)CustomMessageCell SWIFT_WARN_UNUSED_RESULT;
+ (void)setCustomMessageCell:(SWIFT_METATYPE(SBUBaseMessageCell) _Nullable)value;
...
/// since:
/// 3.28.0
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) SWIFT_METATYPE(SBUParentMessageInfoView) _Nonnull ParentMessageInfoView;)
+ (SWIFT_METATYPE(SBUParentMessageInfoView) _Nonnull)ParentMessageInfoView SWIFT_WARN_UNUSED_RESULT;
+ (void)setParentMessageInfoView:(SWIFT_METATYPE(SBUParentMessageInfoView) _Nonnull)value;
@end
...
/// since:
/// 3.28.0
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) SWIFT_METATYPE(SBUBaseMessageCell) _Nonnull TypingIndicatorMessageCell;)
+ (SWIFT_METATYPE(SBUBaseMessageCell) _Nonnull)TypingIndicatorMessageCell SWIFT_WARN_UNUSED_RESULT;
+ (void)setTypingIndicatorMessageCell:(SWIFT_METATYPE(SBUBaseMessageCell) _Nonnull)value;
...
/// since:
/// 3.28.0
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) SWIFT_METATYPE(SBUNewMessageInfo) _Nonnull NewMessageInfo;)
+ (SWIFT_METATYPE(SBUNewMessageInfo) _Nonnull)NewMessageInfo SWIFT_WARN_UNUSED_RESULT;
+ (void)setNewMessageInfo:(SWIFT_METATYPE(SBUNewMessageInfo) _Nonnull)value;
...
@interface SBUActionSheet : NSObject <SBUViewLifeCycle>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
/// This function handles the initialization of views.
- (void)setupViews;
/// This function handles the initialization of styles.
...
@interface SBUActionSheet (SWIFT_EXTENSION(SendbirdUIKit))
/// Dismiss the action sheet.
- (void)dismiss;
/// Called when an action sheet button is clicked.
/// \param sender The button that was clicked.
///
- (void)onClickActionSheetButtonWithSender:(UIButton * _Nonnull)sender;
@end
...
/// The boolean value whether the <code>feedbackView</code> instance should appear or not. The default is <code>true</code>
/// important:
/// If it’s true, <code>feedbackView</code> never appears even if the <code>userMessage</code> has valid status of <code>myFeedbackStatus</code>.
/// since:
/// 3.11.0
@property (nonatomic, readonly) BOOL shouldHideFeedback;
/// The array of <code>SBUFeedbackView</code> instance.
/// If you want to override that view, override the <code>createFeedbackView()</code> constructor function.
/// since:
/// 3.15.0
@property (nonatomic, readonly, strong) SBUFeedbackView * _Nullable feedbackView;
/// If this flag is set to true,
/// the layout will be reset when <code>prepareForReuse()</code> is called.
/// since:
/// 3.21.0
@property (nonatomic) BOOL isMessyViewHierarchy;
- (void)setupViews;
- (void)setupActions;
- (void)setupLayouts;
- (void)setupStyles;
...
/// <code>SBUAlertView</code> is a class that displays an alert view in the SendbirdUIKit.
SWIFT_CLASS("_TtC13SendbirdUIKit12SBUAlertView")
@interface SBUAlertView : NSObject <SBUViewLifeCycle>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
/// This function handles the initialization of views.
- (void)setupViews;
/// This function handles the initialization of styles.
...
@interface SBUAlertView (SWIFT_EXTENSION(SendbirdUIKit))
/// Dismisses the alert view.
- (void)dismiss;
/// This function is called when the button is clicked.
/// since:
/// 3.28.0
- (void)onClickAlertButtonWithSender:(UIButton * _Nonnull)sender;
@end
...
/// since:
/// 3.28.0
SWIFT_CLASS("_TtC13SendbirdUIKit16SBUBarButtonItem")
@interface SBUBarButtonItem : UIBarButtonItem
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
/// note:
/// Use <code>openFile(_:)</code> instead.
/// since:
/// 3.0.0
...
/// \param user <code>SBUUser</code> object
///
/// \param isOpenChannel Set the property to <code>true</code> if you’re using it in an open channel.
///
- (void)showUserProfileWithUser:(SBUUser * _Nonnull)user isOpenChannel:(BOOL)isOpenChannel;
...
/// since:
/// 3.28.0
- (void)baseChannelModule:(Header * _Nonnull)headerComponent didUpdateLeftItems:(NSArray<UIBarButtonItem *> * _Nullable)leftItems;
/// since:
/// 3.28.0
- (void)baseChannelModule:(Header * _Nonnull)headerComponent didUpdateRightItems:(NSArray<UIBarButtonItem *> * _Nullable)rightItems;
...
/// since:
/// 3.22.0
/// \param keyboardFrame The frame of the keyboard as an <code>CGRect</code> object. This value typically comes from the keyboard’s notification <code>userInfo</code> dictionary.
///
///
/// returns:
/// The adjusted keyboard height as a <code>CGFloat</code>. This height accounts for the safe area insets and is adjusted if there are input accessory views present.
- (CGFloat)getAdjustedKeyboardHeightWith:(CGRect)keyboardFrame SWIFT_WARN_UNUSED_RESULT;
/// Calculates the height of the tab bar, adjusting for whether it is translucent.
/// note:
/// When the tab bar is not translucent (<code>isTranslucent=false</code>), its height might be calculated unnecessarily.
/// since:
/// 3.22.0
///
/// returns:
/// The height of the tab bar as a <code>CGFloat</code>.
- (CGFloat)getTabBarHeight SWIFT_WARN_UNUSED_RESULT;
@end
...
@interface SBUBaseMessageCell (SWIFT_EXTENSION(SendbirdUIKit))
/// This is function to create and set up the <code>SBUFeedbackView</code>.
/// since:
/// 3.15.0
/// \param feedback Form list data.
///
/// \param Status Cached form answer datas.
///
///
/// returns:
/// If <code>true</code>, succeeds in creating a valid form view
- (void)updateFeedbackViewWith:(SBDBaseMessage * _Nullable)message;
/// Methods to use when you want to fully customize the design of the <code>SBUFeedbackView</code>.
/// Create your own view that inherits from <code>SBUFeedbackView</code> and return it.
/// NOTE: The default view is <code>SBUSimpleFeedbackView</code>, which has default icons.
/// since:
/// 3.15.0
///
/// returns:
/// Views that inherit from <code>SBUFeedbackView</code>.
- (SBUFeedbackView * _Nonnull)createFeedbackView SWIFT_WARN_UNUSED_RESULT;
@end
...
/// since:
/// 3.28.0
SWIFT_CLASS("_TtC13SendbirdUIKit24SBUBottomSheetController")
@interface SBUBottomSheetController : UIPresentationController
/// Regular init.
...
- (void)drag:(UIPanGestureRecognizer * _Nonnull)gesture;
@end


SWIFT_CLASS("_TtC13SendbirdUIKit21SBUCategoryFilterCell")
@interface SBUCategoryFilterCell : UICollectionViewCell <SBUViewLifeCycle>
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (void)setupViews;
- (void)setupStyles;
...
/// since:
/// 3.28.0
SWIFT_CLASS("_TtC13SendbirdUIKit25SBUChannelPushSettingCell")
@interface SBUChannelPushSettingCell : SBUTableViewCell
/// base vertical stack view
@property (nonatomic, strong) SBUStackView * _Nonnull baseStackView;
...
@property (nonatomic, strong) UISwitch * _Nonnull rightSwitch;
/// radio button
@property (nonatomic, strong) UIButton * _Nonnull rightRadioButton;
/// separate view
@property (nonatomic, strong) UIView * _Nonnull separateView;
/// switch action handler
@property (nonatomic, copy) void (^ _Nullable switchAction)(BOOL);
/// radio action handler
@property (nonatomic, copy) void (^ _Nullable radioButtonAction)(void);
/// Value indicating whether sub type
@property (nonatomic, readonly) BOOL isSubType;
- (void)awakeFromNib;
/// This function handles the initialization of views.
- (void)setupViews;
/// This function handles the initialization of actions.
...
- (void)onSelectRadioButton:(id _Nonnull)sender;
- (nonnull instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString * _Nullable)reuseIdentifier OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
/// The <code>UILabel</code> conforming to <code>SBUViewLifeCycle</code>
/// since:
/// 3.28.0
SWIFT_CLASS("_TtC13SendbirdUIKit8SBULabel")
@interface SBULabel : UILabel
/// Initializes <code>UILabel</code> and set up subviews, auto layouts and actions for SendbirdUIKit.
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
/// Initializes <code>UILabel</code> and set up subviews, auto layouts and actions for SendbirdUIKit.
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER SWIFT_UNAVAILABLE_MSG("'init' has been renamed to 'initWithFrame:'");
...
/// since:
/// 3.28.0
SWIFT_CLASS("_TtC13SendbirdUIKit21SBUChannelStateBanner")
@interface SBUChannelStateBanner : SBULabel
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)setupViews;
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
@end
...
@interface SBUCollectionViewCell (SWIFT_EXTENSION(SendbirdUIKit)) <SBUViewLifeCycle>
- (void)setupViews;
- (void)setupStyles;
- (void)updateStyles;
- (void)setupLayouts;
...
/// since:
/// 3.12.0
@property (nonatomic, strong) SBUStackView * _Nonnull profilesStackView;
...
/// A horizontal stack view that contains <code>mainContainerVStackView</code> and <code>stateView</code> as defaults.
...
/// A horizontal stack view that contains <code>mainContainerView</code> and some other additional views as defaults.
/// As a default, it has ollowing  configuration:
/// since:
/// 3.11.0
/// <ul>
...
///   </li>
/// </ul>
@property (nonatomic, strong) UIStackView * _Nonnull mainContainerVStackView;
...
/// since:
/// 3.21.0
- (void)resetMainContainerViewLayer;
...
/// since:
/// 3.12.0
- (void)configureMessageProfileViewsWithMessage:(SBDBaseMessage * _Nonnull)message;
/// Configure profile views for the user who sent the message.
/// Override this method to customize user profile views.
/// since:
/// 3.12.0
- (void)configureUserProfileViewWithMessage:(SBDBaseMessage * _Nonnull)message;
...
- (void)createChannelModule:(Header * _Nonnull)headerComponent didUpdateLeftItems:(NSArray<UIBarButtonItem *> * _Nullable)leftItems;
- (void)createChannelModule:(Header * _Nonnull)headerComponent didUpdateRightItems:(NSArray<UIBarButtonItem *> * _Nullable)rightItems;
...
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER SWIFT_UNAVAILABLE_MSG("'init' has been renamed to 'SBUCreateOpenChannelViewController()'");
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER SWIFT_UNAVAILABLE_MSG("'init' has been renamed to 'SBUCreateOpenChannelViewController()'");
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)viewDidLoad;
- (void)viewWillAppear:(BOOL)animated;
@property (nonatomic, readonly) UIStatusBarStyle preferredStatusBarStyle;
...
- (void)createOpenChannelModule:(Header * _Nonnull)headerComponent didUpdateLeftItems:(NSArray<UIBarButtonItem *> * _Nullable)leftItems;
- (void)createOpenChannelModule:(Header * _Nonnull)headerComponent didUpdateRightItems:(NSArray<UIBarButtonItem *> * _Nullable)rightItems;
...
/// since:
/// 3.28.0
SWIFT_CLASS("_TtC13SendbirdUIKit26SBUEmojiListViewController")
@interface SBUEmojiListViewController : SBUBaseViewController <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, UIGestureRecognizerDelegate>
...
@property (nonatomic, readonly, copy) NSArray<SBDEmoji *> * _Nonnull emojiList;
@property (nonatomic, readonly, strong) SBDBaseMessage * _Nullable message;
@property (nonatomic) NSInteger maxEmojiOneLine;
/// A handler that gets called when an emoji is tapped.
/// since:
/// 3.28.0
/// \param emojiKey The key of the tapped emoji.
///
/// \param setSelect A boolean indicating whether the emoji should be selected.
///
@property (nonatomic, copy) void (^ _Nullable emojiTapHandler)(NSString * _Nonnull, BOOL);
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER SWIFT_UNAVAILABLE_MSG("'init' has been renamed to 'initWithMessage:'");
...
///
/// returns:
/// The total height required to display all emojis in the collection view.
- (CGFloat)calculateCollectionViewContentHeight SWIFT_WARN_UNUSED_RESULT;
...
@property (nonatomic, strong) Header * _Nullable headerComponent;
@property (nonatomic, strong) CategoryFilter * _Nullable categoryFilterComponent;
...
/// since:
/// 3.15.0
SWIFT_CLASS("_TtC13SendbirdUIKit15SBUFeedbackView")
@interface SBUFeedbackView : SBUView
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
@end
...
/// since:
/// 3.11.0
SWIFT_CLASS("_TtC13SendbirdUIKit16SBUFormFieldView") SWIFT_DEPRECATED_MSG("This method is deprecated in 3.27.0", "_TtC13SendbirdUIKit22SBUMessageFormItemView")
@interface SBUFormFieldView : SBUView <UITextFieldDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
@end
...
/// since:
/// 3.11.0
SWIFT_CLASS("_TtC13SendbirdUIKit11SBUFormView") SWIFT_DEPRECATED_MSG("This method is deprecated in 3.27.0", "_TtC13SendbirdUIKit18SBUMessageFormView")
@interface SBUFormView : SBUView
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
@end
...
/// 3.28.0
- (void)baseChannelListModule:(Header * _Nonnull)headerComponent didUpdateLeftItems:(NSArray<UIBarButtonItem *> * _Nullable)leftItems;
/// 3.28.0
- (void)baseChannelListModule:(Header * _Nonnull)headerComponent didUpdateRightItems:(NSArray<UIBarButtonItem *> * _Nullable)rightItems;
...
- (void)groupChannelPushSettingsModule:(Header * _Nonnull)headerComponent didUpdateLeftItems:(NSArray<UIBarButtonItem *> * _Nullable)leftItems;
- (void)groupChannelPushSettingsModule:(Header * _Nonnull)headerComponent didUpdateRightItems:(NSArray<UIBarButtonItem *> * _Nullable)rightItems;
...
- (void)groupChannelSettingsModule:(Header * _Nonnull)headerComponent didUpdateLeftItems:(NSArray<UIBarButtonItem *> * _Nullable)leftItems;
- (void)groupChannelSettingsModule:(Header * _Nonnull)headerComponent didUpdateRightItems:(NSArray<UIBarButtonItem *> * _Nullable)rightItems;
...
@class SBUSuggestedReplyOptionView;
@class SBDForm;
@class SBDMessageForm;
@class SBDUploadableFileInfo;
@class SBUMessageThreadViewController;
@class SBUReactionsViewController;
...
- (void)groupChannelModule:(SBUGroupChannelModuleList * _Nonnull)listComponent didSelect:(SBUSuggestedReplyOptionView * _Nonnull)suggestedReplyOptionView;
- (void)groupChannelModule:(SBUGroupChannelModuleList * _Nonnull)listComponent didSubmit:(SBDForm * _Nonnull)form messageCell:(SBUBaseMessageCell * _Nonnull)messageCell SWIFT_DEPRECATED_MSG("This method is deprecated in 3.27.0.");
- (void)groupChannelModule:(SBUGroupChannelModuleList * _Nonnull)listComponent didSubmitMessageForm:(SBDMessageForm * _Nonnull)form messageCell:(SBUBaseMessageCell * _Nonnull)messageCell;
- (void)groupChannelModule:(SBUGroupChannelModuleList * _Nonnull)listComponent shouldHandleUncachedTemplateKeys:(NSArray<NSString *> * _Nonnull)templateKeys messageCell:(SBUBaseMessageCell * _Nonnull)messageCell;
- (void)groupChannelModule:(SBUGroupChannelModuleList * _Nonnull)listComponent shouldHandleUncachedTemplateImages:(NSDictionary<NSString *, NSString *> * _Nonnull)cacheData messageCell:(SBUBaseMessageCell * _Nonnull)messageCell;
- (void)baseChannelModule:(SBUBaseChannelModuleList * _Nonnull)listComponent didTapVoiceMessage:(SBDFileMessage * _Nonnull)fileMessage cell:(UITableViewCell * _Nonnull)cell forRowAt:(NSIndexPath * _Nonnull)indexPath;
- (void)baseChannelModuleDidTapScrollToButton:(SBUBaseChannelModuleList * _Nonnull)listComponent animated:(BOOL)animated;
- (void)baseChannelModule:(SBUBaseChannelModuleList * _Nonnull)listComponent didScroll:(UIScrollView * _Nonnull)scrollView;
- (void)baseChannelModule:(Input * _Nonnull)inputComponent didUpdateFrozenState:(BOOL)isFrozen;
...
- (void)groupChannelModule:(SBUGroupChannelModuleInput * _Nonnull)inputComponent didPickMultipleFiles:(NSArray<SBDUploadableFileInfo *> * _Nullable)fileInfoList parentMessage:(SBDBaseMessage * _Nullable)parentMessage;
...
/// since:
/// 3.11.0
- (void)reactionsViewController:(SBUReactionsViewController * _Nonnull)viewController didTapUserProfile:(SBUUser * _Nonnull)user;
/// since:
/// 3.11.0
- (void)reactionsViewController:(SBUReactionsViewController * _Nonnull)viewController tableView:(UITableView * _Nonnull)tableView didSelect:(SBUUser * _Nonnull)user forRowAt:(NSIndexPath * _Nonnull)indexPath;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil SWIFT_UNAVAILABLE;
...
/// since:
/// 3.11.0
SWIFT_CLASS("_TtC13SendbirdUIKit27SBUSuggestedReplyOptionView")
@interface SBUSuggestedReplyOptionView : SBUView
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
@end
...
/// since:
/// 3.23.0
SWIFT_CLASS("_TtC13SendbirdUIKit37SBUHorizontalSuggestedReplyOptionView")
@interface SBUHorizontalSuggestedReplyOptionView : SBUSuggestedReplyOptionView
- (void)setupViews;
- (void)setupLayouts;
- (void)setupStyles;
- (void)setupActions;
...
/// since:
/// 3.11.0
SWIFT_CLASS("_TtC13SendbirdUIKit21SBUSuggestedReplyView")
@interface SBUSuggestedReplyView : SBUView
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
@end


/// This is a horizontal suggested reply view for displaying a list of <code>options</code>.
/// since:
/// 3.23.0
SWIFT_CLASS("_TtC13SendbirdUIKit31SBUHorizontalSuggestedReplyView")
@interface SBUHorizontalSuggestedReplyView : SBUSuggestedReplyView <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
- (void)setupViews;
- (void)setupLayouts;
- (void)setupStyles;
- (NSInteger)collectionView:(UICollectionView * _Nonnull)collectionView numberOfItemsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
...
- (void)inviteUserModule:(Header * _Nonnull)headerComponent didUpdateLeftItems:(NSArray<UIBarButtonItem *> * _Nullable)leftItems;
- (void)inviteUserModule:(Header * _Nonnull)headerComponent didUpdateRightItems:(NSArray<UIBarButtonItem *> * _Nullable)rightItems;
...
@interface SBULabel (SWIFT_EXTENSION(SendbirdUIKit)) <SBUViewLifeCycle>
- (void)setupViews;
- (void)setupLayouts;
- (void)updateLayouts;
- (void)setupStyles;
...
@interface SBULoading : NSObject <SBUViewLifeCycle>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)setupViews;
- (void)setupStyles;
- (void)updateStyles;
...
SWIFT_CLASS("_TtC13SendbirdUIKit17SBULoadingDimView")
@interface SBULoadingDimView : UIView
- (UIView * _Nullable)hitTest:(CGPoint)point withEvent:(UIEvent * _Nullable)event SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
/// since:
/// 3.28.0
SWIFT_CLASS("_TtC13SendbirdUIKit12SBUMediaView")
@interface SBUMediaView : SBUView
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
@end
...
/// since:
/// 3.28.0
SWIFT_CLASS("_TtC13SendbirdUIKit11SBUMenuCell")
@interface SBUMenuCell : SBUTableViewCell
@property (nonatomic, strong) SBUStackView * _Nonnull containerView;
@property (nonatomic, strong) UILabel * _Nonnull titleLabel;
@property (nonatomic, strong) UIImageView * _Nonnull iconImageView;
@property (nonatomic, strong) UIView * _Nonnull lineView;
@property (nonatomic) BOOL isEnabled;
@property (nonatomic, copy) void (^ _Nullable tapHandler)(void (^ _Nonnull)(BOOL));
- (void)setupViews;
- (void)setupLayouts;
- (void)setupStyles;
- (nonnull instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString * _Nullable)reuseIdentifier OBJC_DESIGNATED_INITIALIZER;
...
@property (nonatomic, readonly) NSInteger maxEmojiOneLine;
@property (nonatomic, copy) void (^ _Nullable emojiTapHandler)(NSString * _Nonnull, BOOL);
...
/// since:
/// 3.27.0
SWIFT_CLASS("_TtC13SendbirdUIKit21SBUMesageFormChipView")
@interface SBUMesageFormChipView : SBUView <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
- (void)setupViews;
- (void)setupLayouts;
- (NSInteger)collectionView:(UICollectionView * _Nonnull)collectionView numberOfItemsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UICollectionViewCell * _Nonnull)collectionView:(UICollectionView * _Nonnull)collectionView cellForItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
...
/// since:
/// 3.27.0
SWIFT_CLASS("_TtC13SendbirdUIKit22SBUMessageFormItemView")
@interface SBUMessageFormItemView : SBUView
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
@end
...
/// since:
/// 3.27.0
SWIFT_CLASS("_TtC13SendbirdUIKit27SBUMessageFormChipsItemView")
@interface SBUMessageFormChipsItemView : SBUMessageFormItemView
- (void)setupViews;
- (void)setupLayouts;
- (void)setupStyles;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
/// since:
/// 3.27.0
SWIFT_CLASS("_TtC13SendbirdUIKit18SBUMessageFormView")
@interface SBUMessageFormView : SBUView
- (void)layoutSubviews;
...
///
/// returns:
/// Boolean if submit went successfully
- (BOOL)onSubmit SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
@end
...
/// since:
/// 3.27.0
SWIFT_CLASS("_TtC13SendbirdUIKit26SBUMessageFormFallbackView")
@interface SBUMessageFormFallbackView : SBUMessageFormView
- (void)setupViews;
- (void)setupLayouts;
- (void)setupStyles;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
/// since:
/// 3.27.0
SWIFT_CLASS("_TtC13SendbirdUIKit31SBUMessageFormMultiTextItemView")
@interface SBUMessageFormMultiTextItemView : SBUMessageFormItemView <UITextViewDelegate>
- (void)setupViews;
- (void)setupLayouts;
- (void)setupStyles;
...
/// since:
/// 3.27.0
SWIFT_CLASS("_TtC13SendbirdUIKit32SBUMessageFormSingleTextItemView")
@interface SBUMessageFormSingleTextItemView : SBUMessageFormItemView <UITextFieldDelegate>
- (void)setupViews;
- (void)setupLayouts;
- (void)setupStyles;
- (void)setupActions;
...
/// since:
/// 3.28.0
- (void)createViewModelWithChannelURL:(NSString * _Nonnull)channelURL;
- (void)setupViews;
- (void)setupLayouts;
- (void)setupStyles;
- (void)updateStyles;
...
/// <code>SBUSuggestedReplyView</code> instance.
/// If you want to override that view, override the <code>createSuggestedReplyView()</code> constructor function.
@property (nonatomic, readonly, strong) SBUSuggestedReplyView * _Nullable suggestedReplyView;
/// The boolean value whether the <code>suggestedReplyView</code> instance should appear or not. The default is <code>true</code>
/// important:
/// If it’s true, <code>suggestedReplyView</code> never appears even if the <code>userMessage</code> has quick reply options.
...
- (void)setupActions;
- (void)onTapUserProfileViewWithSender:(UITapGestureRecognizer * _Nonnull)sender;
- (void)updateSuggestedReplyViewWith:(NSArray<NSString *> * _Nullable)options;
...
/// since:
/// [NEXT_VERSION_MFM_THREAD]
- (void)messageThreadModule:(SBUMessageThreadModuleInput * _Nonnull)inputComponent didPickMultipleFiles:(NSArray<SBDUploadableFileInfo *> * _Nonnull)fileInfoList parentMessage:(SBDBaseMessage * _Nonnull)parentMessage;
...
/// since:
/// 3.28.0
SWIFT_CLASS("_TtC13SendbirdUIKit17SBUModerationCell")
@interface SBUModerationCell : SBUBaseChannelSettingCell
- (nonnull instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString * _Nullable)reuseIdentifier OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
- (void)moderationsModule:(Header * _Nonnull)headerComponent didUpdateLeftItems:(NSArray<UIBarButtonItem *> * _Nullable)leftItems;
- (void)moderationsModule:(Header * _Nonnull)headerComponent didUpdateRightItems:(NSArray<UIBarButtonItem *> * _Nullable)rightItems;
...
@interface SBUMultipleFilesMessageCell : SBUContentBaseMessageCell <UICollectionViewDataSource, UICollectionViewDelegate>
...
/// The closure for selection gesture of the specific file at <code>indexPath</code>
...
@interface SBUMultipleFilesMessageCell (SWIFT_EXTENSION(SendbirdUIKit)) <UICollectionViewDelegateFlowLayout>
- (UICollectionViewCell * _Nonnull)collectionView:(UICollectionView * _Nonnull)collectionView cellForItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
- (NSInteger)collectionView:(UICollectionView * _Nonnull)collectionView numberOfItemsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (NSInteger)numberOfSectionsInCollectionView:(UICollectionView * _Nonnull)collectionView SWIFT_WARN_UNUSED_RESULT;
- (void)collectionView:(UICollectionView * _Nonnull)collectionView didSelectItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
...
@interface SBUMultipleFilesMessageCollectionView : UICollectionView <SBUViewLifeCycle>
- (void)setupViews;
- (void)setupLayouts;
- (void)setupStyles;
- (void)setupActions;
...
- (void)openChannelSettingsModule:(Header * _Nonnull)headerComponent didUpdateLeftItems:(NSArray<UIBarButtonItem *> * _Nullable)lefttItems;
- (void)openChannelSettingsModule:(Header * _Nonnull)headerComponent didUpdateRightItems:(NSArray<UIBarButtonItem *> * _Nullable)rightItems;
...
SWIFT_CLASS("_TtC13SendbirdUIKit15SBUPaddingLabel")
@interface SBUPaddingLabel : UILabel
...
///
- (void)onTapContentViewWithSender:(UITapGestureRecognizer * _Nonnull)sender;
/// Calls the <code>fileSelectHandler()</code> when one of thie files is tapped in parent message that is a multiple files message.
/// since:
/// 3.10.0
/// \param sender tapGestureRecognizer
///
...
@interface SBUParentMessageInfoView (SWIFT_EXTENSION(SendbirdUIKit)) <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
- (NSInteger)numberOfSectionsInCollectionView:(UICollectionView * _Nonnull)collectionView SWIFT_WARN_UNUSED_RESULT;
- (NSInteger)collectionView:(UICollectionView * _Nonnull)collectionView numberOfItemsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (CGSize)collectionView:(UICollectionView * _Nonnull)collectionView layout:(UICollectionViewLayout * _Nonnull)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
- (UICollectionViewCell * _Nonnull)collectionView:(UICollectionView * _Nonnull)collectionView cellForItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
...
/// since:
/// 3.11.0
SWIFT_CLASS("_TtC13SendbirdUIKit26SBUReactionsViewController")
@interface SBUReactionsViewController : SBUBaseViewController <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, UITableViewDataSource, UITableViewDelegate>
@property (nonatomic, readonly, strong) UICollectionView * _Nonnull collectionView;
@property (nonatomic, readonly, strong) UICollectionViewFlowLayout * _Nonnull layout;
@property (nonatomic, readonly, strong) UIStackView * _Nonnull stackView;
...
@property (nonatomic, readonly, strong) UITableView * _Nonnull tableView;
@property (nonatomic, readonly, copy) NSArray<SBDEmoji *> * _Nonnull emojiList;
@property (nonatomic, readonly, strong) SBDGroupChannel * _Null_unspecified channel;
@property (nonatomic, readonly, strong) SBDReaction * _Nullable selectedReaction;
@property (nonatomic, readonly, copy) NSArray<SBDMember *> * _Nonnull memberList;
@property (nonatomic, readonly, copy) NSArray<SBDReaction *> * _Nonnull reactionList;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER SWIFT_UNAVAILABLE_MSG("'init' has been renamed to 'initWithChannel:message:selectedReaction:'");
/// Use this function when initialize.
/// \param message BaseMessage types
///
- (nonnull instancetype)initWithChannel:(SBDGroupChannel * _Nonnull)channel message:(SBDBaseMessage * _Nonnull)message selectedReaction:(SBDReaction * _Nullable)selectedReaction OBJC_DESIGNATED_INITIALIZER;
- (void)setupViews;
/// This function handles the initialization of autolayouts.
- (void)setupLayouts;
- (void)updateLayouts;
...
/// since:
/// 3.28.0
- (NSIndexPath * _Nullable)getSelectedIndexPath SWIFT_WARN_UNUSED_RESULT;
/// This function retrieves the size of the cell based on the number of reactions.
/// since:
/// 3.28.0
- (CGSize)getCellSizeWithCount:(NSInteger)count SWIFT_WARN_UNUSED_RESULT;
/// This function retrieves the user for the specified index path.
/// since:
/// 3.28.0
- (SBUUser * _Nullable)getUserWith:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
/// This function sets the user profile tap gesture handling.
/// If you do not want to use the user profile function, override this function and leave it empty.
/// since:
/// 3.11.0
...
- (void)registerOperatorModule:(Header * _Nonnull)headerComponent didUpdateLeftItems:(NSArray<UIBarButtonItem *> * _Nullable)leftItems;
- (void)registerOperatorModule:(Header * _Nonnull)headerComponent didUpdateRightItems:(NSArray<UIBarButtonItem *> * _Nullable)rightItems;
...
/// since:
/// 3.28.0
SWIFT_CLASS("_TtC13SendbirdUIKit19SBUScrollBottomView")
@interface SBUScrollBottomView : SBUView
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (void)setupViews;
- (void)setupLayouts;
- (void)setupStyles;
...
/// since:
/// 3.28.0
SWIFT_CLASS("_TtC13SendbirdUIKit12SBUSearchBar")
@interface SBUSearchBar : UISearchBar <SBUViewLifeCycle>
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)setupViews;
...
/// since:
/// 3.15.0
SWIFT_CLASS("_TtC13SendbirdUIKit21SBUSimpleFeedbackView")
@interface SBUSimpleFeedbackView : SBUFeedbackView
- (void)setupViews;
- (void)setupLayouts;
- (void)setupStyles;
- (void)setupActions;
...
/// since:
/// 3.11.0
SWIFT_CLASS("_TtC13SendbirdUIKit22SBUSimpleFormFieldView") SWIFT_DEPRECATED_MSG("This method is deprecated in 3.27.0", "_TtC13SendbirdUIKit22SBUMessageFormItemView")
@interface SBUSimpleFormFieldView : SBUFormFieldView
- (void)setupViews;
- (void)setupLayouts;
- (void)setupStyles;
- (void)setupActions;
/// Calls <code>SBUFormFieldViewDelegate/formFieldView(_:didUpdate:)</code>
/// since:
/// 3.11.0
- (void)onChangeFieldValueWithTextField:(UITextField * _Nonnull)textField;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
@end
...
/// since:
/// 3.11.0
SWIFT_CLASS("_TtC13SendbirdUIKit17SBUSimpleFormView") SWIFT_DEPRECATED_MSG("This method is deprecated in 3.27.0", "_TtC13SendbirdUIKit18SBUMessageFormView")
@interface SBUSimpleFormView : SBUFormView
- (void)setupViews;
- (void)setupLayouts;
- (void)setupStyles;
- (void)setupActions;
...
/// since:
/// 3.27.0
SWIFT_CLASS("_TtC13SendbirdUIKit24SBUSimpleMessageFormView")
@interface SBUSimpleMessageFormView : SBUMessageFormView
- (void)setupViews;
- (void)setupLayouts;
- (void)setupStyles;
- (void)setupActions;
...
/// since:
/// 3.11.0
SWIFT_CLASS("_TtC13SendbirdUIKit33SBUSimpleSuggestedReplyOptionView")
@interface SBUSimpleSuggestedReplyOptionView : SBUSuggestedReplyOptionView
- (void)setupViews;
- (void)setupLayouts;
- (void)setupStyles;
- (void)setupActions;
/// Calls <code>SBUSuggestedReplyOptionViewDelegate/suggestedReplyOptionViewDidSelect(_:)</code>
/// note:
...
/// since:
/// 3.27.0
SWIFT_CLASS("_TtC13SendbirdUIKit11SBUTextView")
@interface SBUTextView : UITextView <SBUViewLifeCycle>
/// placeholder font
...
/// since:
/// 3.15.0
SWIFT_CLASS("_TtC13SendbirdUIKit12SBUToastView")
@interface SBUToastView : NSObject <SBUViewLifeCycle>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
/// This function handles the initialization of views.
- (void)setupViews;
/// This function handles the initialization of styles.
...
/// since:
/// 3.12.0
SWIFT_CLASS("_TtC13SendbirdUIKit28SBUTypingIndicatorBubbleView")
@interface SBUTypingIndicatorBubbleView : SBUView
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (void)setupViews;
- (void)setupLayouts;
@property (nonatomic, readonly) CGSize intrinsicContentSize;
...
/// A message cell that displays a typing indicator message. (<code>SBUTypingIndicatorMessage</code>).
/// since:
/// 3.12.0
SWIFT_CLASS("_TtC13SendbirdUIKit29SBUTypingIndicatorMessageCell")
@interface SBUTypingIndicatorMessageCell : SBUContentBaseMessageCell
@property (nonatomic, strong) UIView * _Nonnull typingBubbleView;
- (void)setupViews;
- (void)setupLayouts;
- (void)setupActions;
- (void)setupStyles;
...
/// 3.11.0
@property (nonatomic, readonly, strong) SBUSuggestedReplyView * _Nullable suggestedReplyView;
/// The boolean value whether the <code>messageFormView</code> instance should appear or not. The default is <code>true</code>
/// important:
/// If it’s true, <code>messageFormView</code> never appears even if the <code>userMessage</code> has <code>forms</code>.
/// since:
/// 3.11.0
@property (nonatomic, readonly) BOOL shouldHideFormTypeMessage;
/// The array of <code>SBUFormView</code> instance.
/// If you want to override that view, override the <code>createFormView()</code> constructor function.
/// since:
/// 3.11.0
@property (nonatomic, readonly, copy) NSArray<SBUFormView *> * _Nullable formViews SWIFT_DEPRECATED_MSG("This method is deprecated in 3.27.0.");
/// The array of <code>SBUMessageFormView</code> instance.
/// If you want to override that view, override the <code>createMessageFormView()</code> constructor function.
/// since:
/// 3.27.0
...
- (void)setSelected:(BOOL)selected animated:(BOOL)animated;
- (void)onTapWebviewWithSender:(UITapGestureRecognizer * _Nonnull)sender;
/// This is function to create and set up the <code>SBUSuggestedReplyView</code>.
/// since:
/// 3.11.0
...
/// Method to use when you want to fully customize the design of the <code>SBUSuggestedReplyView</code>.
/// Create your own view that inherits from <code>SBUSuggestedReplyView</code> and return it.
/// NOTE: The default view is <code>SBUVerticalSuggestedReplyView</code>, which is a vertically organized option view.
/// since:
/// 3.11.0
///
/// returns:
/// Views that inherit from <code>SBUSuggestedReplyView</code>.
- (SBUSuggestedReplyView * _Nonnull)createSuggestedReplyView SWIFT_WARN_UNUSED_RESULT;
/// This is function to create and set up the <code>[SBUMessageFormView]</code>.
/// since:
/// 3.11.0
...
/// returns:
/// If <code>true</code>, succeeds in creating a valid form view
- (BOOL)updateFormViewWith:(SBDBaseMessage * _Nullable)message SWIFT_WARN_UNUSED_RESULT SWIFT_DEPRECATED_MSG("This method is deprecated in 3.27.0.");
- (BOOL)updateMessageFormViewWith:(SBDBaseMessage * _Nullable)message SWIFT_WARN_UNUSED_RESULT;
/// Methods to use when you want to fully customize the design of the <code>SBUFormView</code>.
/// Create your own view that inherits from <code>SBUFormView</code> and return it.
/// NOTE: The default view is <code>SBUSimpleFormView</code>, which is a vertically organized form view.
/// since:
/// 3.11.0
///
/// returns:
/// Views that inherit from <code>SBUFormView</code>.
- (SBUFormView * _Nonnull)createFormView SWIFT_WARN_UNUSED_RESULT SWIFT_DEPRECATED_MSG("This method is deprecated in 3.27.0.");
/// Methods to use when you want to fully customize the design of the <code>SBUMessageFormView</code>.
/// Create your own view that inherits from <code>SBUMessageFormView</code> and return it.
/// NOTE: The default view is <code>SBUSimpleMessageFormView</code>, which is a vertically organized form view.
/// since:
/// 3.27.0
///
/// returns:
/// Views that inherit from <code>SBUMessageFormView</code>.
...
- (void)suggestedReplyView:(SBUSuggestedReplyView * _Nonnull)view didSelectOption:(SBUSuggestedReplyOptionView * _Nonnull)optionView;
- (void)formView:(SBUFormView * _Nonnull)view didSubmit:(SBDMessageForm * _Nonnull)form SWIFT_DEPRECATED_MSG("This method is deprecated in 3.27.0.");
- (void)messageFormView:(SBUMessageFormView * _Nonnull)view didSubmit:(SBDMessageForm * _Nonnull)form;
- (void)messageFormView:(SBUMessageFormView * _Nonnull)view didUpdateValidationStatus:(NSDictionary<NSNumber *, NSNumber *> * _Nonnull)status;
- (void)messageFormView:(SBUMessageFormView * _Nonnull)view didUpdateViewFrame:(CGRect)didUpdateViewFrame;
- (nonnull instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString * _Nullable)reuseIdentifier OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
- (void)userListModule:(Header * _Nonnull)headerComponent didUpdateLeftItems:(NSArray<UIBarButtonItem *> * _Nullable)leftItems;
- (void)userListModule:(Header * _Nonnull)headerComponent didUpdateRightItems:(NSArray<UIBarButtonItem *> * _Nullable)rightItems;
...
/// since:
/// 3.28.0
SWIFT_CLASS("_TtC13SendbirdUIKit18SBUUserProfileView")
@interface SBUUserProfileView : UIView
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER SWIFT_UNAVAILABLE_MSG("'init' has been renamed to 'SBUUserProfileView.init(delegate:)'");
- (void)drawRect:(CGRect)rect;
- (void)layoutSubviews;
...
/// This is a vertical suggested reply view for displaying a list of <code>options</code>.
/// since:
/// 3.11.0
SWIFT_CLASS("_TtC13SendbirdUIKit29SBUVerticalSuggestedReplyView")
@interface SBUVerticalSuggestedReplyView : SBUSuggestedReplyView
- (void)setupViews;
- (void)setupLayouts;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
...
@interface SBUVoiceMessageInputView : NSObject <SBUViewLifeCycle>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)setupViews;
- (void)setupLayouts;
- (void)updateLayouts;
